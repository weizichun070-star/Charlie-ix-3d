...
`)+`
`+l);const T=A+p+a,E=A+l+o,I=ho(r,r.VERTEX_SHADER,T),b=ho(r,r.FRAGMENT_SHADER,E);r.attachShader(M,I),r.attachShader(M,b),e.index0AttributeName!==void 0?r.bindAttribLocation(M,0,e.index0AttributeName):e.morphTargets===!0&&r.bindAttribLocation(M,0,"position"),r.linkProgram(M);function w(R){if(i.debug.checkShaderErrors){const G=r.getProgramInfoLog(M).trim(),O=r.getShaderInfoLog(I).trim(),W=r.getShaderInfoLog(b).trim();let q=!0,V=!0;if(r.getProgramParameter(M,r.LINK_STATUS)===!1)if(q=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,M,I,b);else{const X=po(r,I,"vertex"),H=po(r,b,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(M,r.VALIDATE_STATUS)+`
...
}`;function ap(i,t,e){let n=new ha;const r=new Wt,s=new Wt,a=new $t,o=new np({depthPacking:jc}),c=new ip,u={},h=e.maxTextureSize,d={[Cn]:be,[be]:Cn,[ln]:ln},f=new Pn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Wt},radius:{value:4}},vertexShader:rp,fragmentShader:sp}),m=f.clone();m.defines.HORIZONTAL_PASS=1;const g=new _n;g.setAttribute("position",new je(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new Mt(g,f),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Uo;let l=this.type;this.render=function(b,w,C){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||b.length===0)return;const S=i.getRenderTarget(),x=i.getActiveCubeFace(),R=i.getActiveMipmapLevel(),G=i.state;G.setBlending(wn),G.buffers.color.setClear(1,1,1,1),G.buffers.depth.setTest(!0),G.setScissorTest(!1);const O=l!==cn&&this.type===cn,W=l===cn&&this.type!==cn;for(let q=0,V=b.length;q<V;q++){const X=b[q],H=X.shadow;if(H===void 0){console.warn("THREE.WebGLShadowMap:",X,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;r.copy(H.mapSize);const et=H.getFrameExtents();if(r.multiply(et),s.copy(H.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/et.x),r.x=s.x*et.x,H.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/et.y),r.y=s.y*et.y,H.mapSize.y=s.y)),H.map===null||O===!0||W===!0){const ft=this.type!==cn?{minFilter:Xe,magFilter:Xe}:{};H.map!==null&&H.map.dispose(),H.map=new qn(r.x,r.y,ft),H.map.texture.name=X.name+".shadowMap",H.camera.updateProjectionMatrix()}i.setRenderTarget(H.map),i.clear();const rt=H.getViewportCount();for(let ft=0;ft<rt;ft++){const It=H.getViewport(ft);a.set(s.x*It.x,s.y*It.y,s.x*It.z,s.y*It.w),G.viewport(a),H.updateMatrices(X,ft),n=H.getFrustum(),E(w,C,H.camera,X,this.type)}H.isPointLightShadow!==!0&&this.type===cn&&A(H,C),H.needsUpdate=!1}l=this.type,p.needsUpdate=!1,i.setRenderTarget(S,x,R)};function A(b,w){const C=t.update(M);f.defines.VSM_SAMPLES!==b.blurSamples&&(f.defines.VSM_SAMPLES=b.blurSamples,m.defines.VSM_SAMPLES=b.blurSamples,f.needsUpdate=!0,m.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new qn(r.x,r.y)),f.uniforms.shadow_pass.value=b.map.texture,f.uniforms.resolution.value=b.mapSize,f.uniforms.radius.value=b.radius,i.setRenderTarget(b.mapPass),i.clear(),i.renderBufferDirect(w,null,C,f,M,null),m.uniforms.shadow_pass.value=b.mapPass.texture,m.uniforms.resolution.value=b.mapSize,m.uniforms.radius.value=b.radius,i.setRenderTarget(b.map),i.clear(),i.renderBufferDirect(w,null,C,m,M,null)}function T(b,w,C,S){let x=null;const R=C.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(R!==void 0)x=R;else if(x=C.isPointLight===!0?c:o,i.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0){const G=x.uuid,O=w.uuid;let W=u[G];W===void 0&&(W={},u[G]=W);let q=W[O];q===void 0&&(q=x.clone(),W[O]=q,w.addEventListener("dispose",I)),x=q}if(x.visible=w.visible,x.wireframe=w.wireframe,S===cn?x.side=w.shadowSide!==null?w.shadowSide:w.side:x.side=w.shadowSide!==null?w.shadowSide:d[w.side],x.alphaMap=w.alphaMap,x.alphaTest=w.alphaTest,x.map=w.map,x.clipShadows=w.clipShadows,x.clippingPlanes=w.clippingPlanes,x.clipIntersection=w.clipIntersection,x.displacementMap=w.displacementMap,x.displacementScale=w.displacementScale,x.displacementBias=w.displacementBias,x.wireframeLinewidth=w.wireframeLinewidth,x.linewidth=w.linewidth,C.isPointLight===!0&&x.isMeshDistanceMaterial===!0){const G=i.properties.get(x);G.light=C}return x}function E(b,w,C,S,x){if(b.visible===!1)return;if(b.layers.test(w.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&x===cn)&&(!b.frustumCulled||n.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(C.matrixWorldInverse,b.matrixWorld);const O=t.update(b),W=b.material;if(Array.isArray(W)){const q=O.groups;for(let V=0,X=q.length;V<X;V++){const H=q[V],et=W[H.materialIndex];if(et&&et.visible){const rt=T(b,et,S,x);b.onBeforeShadow(i,b,w,C,O,rt,H),i.renderBufferDirect(C,null,O,rt,b,H),b.onAfterShadow(i,b,w,C,O,rt,H)}}}else if(W.visible){const q=T(b,W,S,x);b.onBeforeShadow(i,b,w,C,O,q,null),i.renderBufferDirect(C,null,O,q,b,null),b.onAfterShadow(i,b,w,C,O,q,null)}}const G=b.children;for(let O=0,W=G.length;O<W;O++)E(G[O],w,C,S,x)}function I(b){b.target.removeEventListener("dispose",I);for(const C in u){const S=u[C],x=b.target.uuid;x in S&&(S[x].dispose(),delete S[x])}}}const op={[_s]:gs,[vs]:Ss,[xs]:Es,[gi]:Ms,[gs]:_s,[Ss]:vs,[Es]:xs,[Ms]:gi};function cp(i,t){function e(){let P=!1;const it=new $t;let k=null;const $=new $t(0,0,0,0);return{setMask:function(lt){k!==lt&&!P&&(i.colorMask(lt,lt,lt,lt),k=lt)},setLocked:function(lt){P=lt},setClear:function(lt,ot,Rt,se,me){me===!0&&(lt*=se,ot*=se,Rt*=se),it.set(lt,ot,Rt,se),$.equals(it)===!1&&(i.clearColor(lt,ot,Rt,se),$.copy(it))},reset:function(){P=!1,k=null,$.set(-1,0,0,0)}}}function n(){let P=!1,it=!1,k=null,$=null,lt=null;return{setReversed:function(ot){if(it!==ot){const Rt=t.get("EXT_clip_control");it?Rt.clipControlEXT(Rt.LOWER_LEFT_EXT,Rt.ZERO_TO_ONE_EXT):Rt.clipControlEXT(Rt.LOWER_LEFT_EXT,Rt.NEGATIVE_ONE_TO_ONE_EXT);const se=lt;lt=null,this.setClear(se)}it=ot},getReversed:function(){return it},setTest:function(ot){ot?st(i.DEPTH_TEST):Tt(i.DEPTH_TEST)},setMask:function(ot){k!==ot&&!P&&(i.depthMask(ot),k=ot)},setFunc:function(ot){if(it&&(ot=op[ot]),$!==ot){switch(ot){case _s:i.depthFunc(i.NEVER);break;case gs:i.depthFunc(i.ALWAYS);break;case vs:i.depthFunc(i.LESS);break;case gi:i.depthFunc(i.LEQUAL);break;case xs:i.depthFunc(i.EQUAL);break;case Ms:i.depthFunc(i.GEQUAL);break;case Ss:i.depthFunc(i.GREATER);break;case Es:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}$=ot}},setLocked:function(ot){P=ot},setClear:function(ot){lt!==ot&&(it&&(ot=1-ot),i.clearDepth(ot),lt=ot)},reset:function(){P=!1,k=null,$=null,lt=null,it=!1}}}function r(){let P=!1,it=null,k=null,$=null,lt=null,ot=null,Rt=null,se=null,me=null;return{setTest:function(Zt){P||(Zt?st(i.STENCIL_TEST):Tt(i.STENCIL_TEST))},setMask:function(Zt){it!==Zt&&!P&&(i.stencilMask(Zt),it=Zt)},setFunc:function(Zt,Be,tn){(k!==Zt||$!==Be||lt!==tn)&&(i.stencilFunc(Zt,Be,tn),k=Zt,$=Be,lt=tn)},setOp:function(Zt,Be,tn){(ot!==Zt||Rt!==Be||se!==tn)&&(i.stencilOp(Zt,Be,tn),ot=Zt,Rt=Be,se=tn)},setLocked:function(Zt){P=Zt},setClear:function(Zt){me!==Zt&&(i.clearStencil(Zt),me=Zt)},reset:function(){P=!1,it=null,k=null,$=null,lt=null,ot=null,Rt=null,se=null,me=null}}}const s=new e,a=new n,o=new r,c=new WeakMap,u=new WeakMap;let h={},d={},f=new WeakMap,m=[],g=null,M=!1,p=null,l=null,A=null,T=null,E=null,I=null,b=null,w=new Ft(0,0,0),C=0,S=!1,x=null,R=null,G=null,O=null,W=null;const q=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let V=!1,X=0;const H=i.getParameter(i.VERSION);H.indexOf("WebGL")!==-1?(X=parseFloat(/^WebGL (\d)/.exec(H)[1]),V=X>=1):H.indexOf("OpenGL ES")!==-1&&(X=parseFloat(/^OpenGL ES (\d)/.exec(H)[1]),V=X>=2);let et=null,rt={};const ft=i.getParameter(i.SCISSOR_BOX),It=i.getParameter(i.VIEWPORT),Xt=new $t().fromArray(ft),Z=new $t().fromArray(It);function tt(P,it,k,$){const lt=new Uint8Array(4),ot=i.createTexture();i.bindTexture(P,ot),i.texParameteri(P,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(P,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Rt=0;Rt<k;Rt++)P===i.TEXTURE_3D||P===i.TEXTURE_2D_ARRAY?i.texImage3D(it,0,i.RGBA,1,1,$,0,i.RGBA,i.UNSIGNED_BYTE,lt):i.texImage2D(it+Rt,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,lt);return ot}const gt={};gt[i.TEXTURE_2D]=tt(i.TEXTURE_2D,i.TEXTURE_2D,1),gt[i.TEXTURE_CUBE_MAP]=tt(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),gt[i.TEXTURE_2D_ARRAY]=tt(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),gt[i.TEXTURE_3D]=tt(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),st(i.DEPTH_TEST),a.setFunc(gi),Ot(!1),Bt(Ta),st(i.CULL_FACE),U(wn);function st(P){h[P]!==!0&&(i.enable(P),h[P]=!0)}function Tt(P){h[P]!==!1&&(i.disable(P),h[P]=!1)}function wt(P,it){return d[P]!==it?(i.bindFramebuffer(P,it),d[P]=it,P===i.DRAW_FRAMEBUFFER&&(d[i.FRAMEBUFFER]=it),P===i.FRAMEBUFFER&&(d[i.DRAW_FRAMEBUFFER]=it),!0):!1}function Nt(P,it){let k=m,$=!1;if(P){k=f.get(it),k===void 0&&(k=[],f.set(it,k));const lt=P.textures;if(k.length!==lt.length||k[0]!==i.COLOR_ATTACHMENT0){for(let ot=0,Rt=lt.length;ot<Rt;ot++)k[ot]=i.COLOR_ATTACHMENT0+ot;k.length=lt.length,$=!0}}else k[0]!==i.BACK&&(k[0]=i.BACK,$=!0);$&&i.drawBuffers(k)}function re(P){return g!==P?(i.useProgram(P),g=P,!0):!1}const Ht={[Hn]:i.FUNC_ADD,[Tc]:i.FUNC_SUBTRACT,[Ac]:i.FUNC_REVERSE_SUBTRACT};Ht[bc]=i.MIN,Ht[wc]=i.MAX;const ae={[Rc]:i.ZERO,[Cc]:i.ONE,[Pc]:i.SRC_COLOR,[ps]:i.SRC_ALPHA,[Fc]:i.SRC_ALPHA_SATURATE,[Ic]:i.DST_COLOR,[Dc]:i.DST_ALPHA,[Lc]:i.ONE_MINUS_SRC_COLOR,[ms]:i.ONE_MINUS_SRC_ALPHA,[Nc]:i.ONE_MINUS_DST_COLOR,[Uc]:i.ONE_MINUS_DST_ALPHA,[Oc]:i.CONSTANT_COLOR,[Bc]:i.ONE_MINUS_CONSTANT_COLOR,[zc]:i.CONSTANT_ALPHA,[Hc]:i.ONE_MINUS_CONSTANT_ALPHA};function U(P,it,k,$,lt,ot,Rt,se,me,Zt){if(P===wn){M===!0&&(Tt(i.BLEND),M=!1);return}if(M===!1&&(st(i.BLEND),M=!0),P!==yc){if(P!==p||Zt!==S){if((l!==Hn||E!==Hn)&&(i.blendEquation(i.FUNC_ADD),l=Hn,E=Hn),Zt)switch(P){case fi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Aa:i.blendFunc(i.ONE,i.ONE);break;case ba:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case wa:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}else switch(P){case fi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Aa:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case ba:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case wa:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}A=null,T=null,I=null,b=null,w.set(0,0,0),C=0,p=P,S=Zt}return}lt=lt||it,ot=ot||k,Rt=Rt||$,(it!==l||lt!==E)&&(i.blendEquationSeparate(Ht[it],Ht[lt]),l=it,E=lt),(k!==A||$!==T||ot!==I||Rt!==b)&&(i.blendFuncSeparate(ae[k],ae[$],ae[ot],ae[Rt]),A=k,T=$,I=ot,b=Rt),(se.equals(w)===!1||me!==C)&&(i.blendColor(se.r,se.g,se.b,me),w.copy(se),C=me),p=P,S=!1}function Le(P,it){P.side===ln?Tt(i.CULL_FACE):st(i.CULL_FACE);let k=P.side===be;it&&(k=!k),Ot(k),P.blending===fi&&P.transparent===!1?U(wn):U(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),a.setFunc(P.depthFunc),a.setTest(P.depthTest),a.setMask(P.depthWrite),s.setMask(P.colorWrite);const $=P.stencilWrite;o.setTest($),$&&(o.setMask(P.stencilWriteMask),o.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),o.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),te(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?st(i.SAMPLE_ALPHA_TO_COVERAGE):Tt(i.SAMPLE_ALPHA_TO_COVERAGE)}function Ot(P){x!==P&&(P?i.frontFace(i.CW):i.frontFace(i.CCW),x=P)}function Bt(P){P!==Sc?(st(i.CULL_FACE),P!==R&&(P===Ta?i.cullFace(i.BACK):P===Ec?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Tt(i.CULL_FACE),R=P}function Et(P){P!==G&&(V&&i.lineWidth(P),G=P)}function te(P,it,k){P?(st(i.POLYGON_OFFSET_FILL),(O!==it||W!==k)&&(i.polygonOffset(it,k),O=it,W=k)):Tt(i.POLYGON_OFFSET_FILL)}function St(P){P?st(i.SCISSOR_TEST):Tt(i.SCISSOR_TEST)}function y(P){P===void 0&&(P=i.TEXTURE0+q-1),et!==P&&(i.activeTexture(P),et=P)}function _(P,it,k){k===void 0&&(et===null?k=i.TEXTURE0+q-1:k=et);let $=rt[k];$===void 0&&($={type:void 0,texture:void 0},rt[k]=$),($.type!==P||$.texture!==it)&&(et!==k&&(i.activeTexture(k),et=k),i.bindTexture(P,it||gt[P]),$.type=P,$.texture=it)}function F(){const P=rt[et];P!==void 0&&P.type!==void 0&&(i.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function K(){try{i.compressedTexImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function j(){try{i.compressedTexImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Y(){try{i.texSubImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function vt(){try{i.texSubImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function at(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ut(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Gt(){try{i.texStorage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function J(){try{i.texStorage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ht(){try{i.texImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function yt(){try{i.texImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function At(P){Xt.equals(P)===!1&&(i.scissor(P.x,P.y,P.z,P.w),Xt.copy(P))}function dt(P){Z.equals(P)===!1&&(i.viewport(P.x,P.y,P.z,P.w),Z.copy(P))}function zt(P,it){let k=u.get(it);k===void 0&&(k=new WeakMap,u.set(it,k));let $=k.get(P);$===void 0&&($=i.getUniformBlockIndex(it,P.name),k.set(P,$))}function Lt(P,it){const $=u.get(it).get(P);c.get(it)!==$&&(i.uniformBlockBinding(it,$,P.__bindingPointIndex),c.set(it,$))}function Jt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},et=null,rt={},d={},f=new WeakMap,m=[],g=null,M=!1,p=null,l=null,A=null,T=null,E=null,I=null,b=null,w=new Ft(0,0,0),C=0,S=!1,x=null,R=null,G=null,O=null,W=null,Xt.set(0,0,i.canvas.width,i.canvas.height),Z.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:st,disable:Tt,bindFramebuffer:wt,drawBuffers:Nt,useProgram:re,setBlending:U,setMaterial:Le,setFlipSided:Ot,setCullFace:Bt,setLineWidth:Et,setPolygonOffset:te,setScissorTest:St,activeTexture:y,bindTexture:_,unbindTexture:F,compressedTexImage2D:K,compressedTexImage3D:j,texImage2D:ht,texImage3D:yt,updateUBOMapping:zt,uniformBlockBinding:Lt,texStorage2D:Gt,texStorage3D:J,texSubImage2D:Y,texSubImage3D:vt,compressedTexSubImage2D:at,compressedTexSubImage3D:ut,scissor:At,viewport:dt,reset:Jt}}function Eo(i,t,e,n){const r=lp(n);switch(e){case Go:return i*t;case ko:return i*t;case Wo:return i*t*2;case Xo:return i*t/r.components*r.byteLength;case aa:return i*t/r.components*r.byteLength;case qo:return i*t*2/r.components*r.byteLength;case oa:return i*t*2/r.components*r.byteLength;case Vo:return i*t*3/r.components*r.byteLength;case We:return i*t*4/r.components*r.byteLength;case ca:return i*t*4/r.components*r.byteLength;case mr:case _r:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*8;case gr:case vr:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case ws:case Cs:return Math.max(i,16)*Math.max(t,8)/4;case bs:case Rs:return Math.max(i,8)*Math.max(t,8)/2;case Ps:case Ls:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*8;case Ds:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case Us:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case Is:return Math.floor((i+4)/5)*Math.floor((t+3)/4)*16;case Ns:return Math.floor((i+4)/5)*Math.floor((t+4)/5)*16;case Fs:return Math.floor((i+5)/6)*Math.floor((t+4)/5)*16;case Os:return Math.floor((i+5)/6)*Math.floor((t+5)/6)*16;case Bs:return Math.floor((i+7)/8)*Math.floor((t+4)/5)*16;case zs:return Math.floor((i+7)/8)*Math.floor((t+5)/6)*16;case Hs:return Math.floor((i+7)/8)*Math.floor((t+7)/8)*16;case Gs:return Math.floor((i+9)/10)*Math.floor((t+4)/5)*16;case Vs:return Math.floor((i+9)/10)*Math.floor((t+5)/6)*16;case ks:return Math.floor((i+9)/10)*Math.floor((t+7)/8)*16;case Ws:return Math.floor((i+9)/10)*Math.floor((t+9)/10)*16;case Xs:return Math.floor((i+11)/12)*Math.floor((t+9)/10)*16;case qs:return Math.floor((i+11)/12)*Math.floor((t+11)/12)*16;case xr:case Ys:case Zs:return Math.ceil(i/4)*Math.ceil(t/4)*16;case Yo:case Ks:return Math.ceil(i/4)*Math.ceil(t/4)*8;case $s:case js:return Math.ceil(i/4)*Math.ceil(t/4)*16}throw new Error(`Unable to determine texture byte length for ${e} format.`)}function lp(i){switch(i){case mn:case Bo:return{byteLength:1,components:1};case Fi:case zo:case Bi:return{byteLength:2,components:1};case ra:case sa:return{byteLength:2,components:4};case Xn:case ia:case hn:return{byteLength:4,components:1};case Ho:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function up(i,t,e,n,r,s,a){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new Wt,h=new WeakMap;let d;const f=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(y,_){return m?new OffscreenCanvas(y,_):wr("canvas")}function M(y,_,F){let K=1;const j=St(y);if((j.width>F||j.height>F)&&(K=F/Math.max(j.width,j.height)),K<1)if(typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&y instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&y instanceof ImageBitmap||typeof VideoFrame<"u"&&y instanceof VideoFrame){const Y=Math.floor(K*j.width),vt=Math.floor(K*j.height);d===void 0&&(d=g(Y,vt));const at=_?g(Y,vt):d;return at.width=Y,at.height=vt,at.getContext("2d").drawImage(y,0,0,Y,vt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+j.width+"x"+j.height+") to ("+Y+"x"+vt+")."),at}else return"data"in y&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+j.width+"x"+j.height+")."),y;return y}function p(y){return y.generateMipmaps}function l(y){i.generateMipmap(y)}function A(y){return y.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:y.isWebGL3DRenderTarget?i.TEXTURE_3D:y.isWebGLArrayRenderTarget||y.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function T(y,_,F,K,j=!1){if(y!==null){if(i[y]!==void 0)return i[y];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+y+"'")}let Y=_;if(_===i.RED&&(F===i.FLOAT&&(Y=i.R32F),F===i.HALF_FLOAT&&(Y=i.R16F),F===i.UNSIGNED_BYTE&&(Y=i.R8)),_===i.RED_INTEGER&&(F===i.UNSIGNED_BYTE&&(Y=i.R8UI),F===i.UNSIGNED_SHORT&&(Y=i.R16UI),F===i.UNSIGNED_INT&&(Y=i.R32UI),F===i.BYTE&&(Y=i.R8I),F===i.SHORT&&(Y=i.R16I),F===i.INT&&(Y=i.R32I)),_===i.RG&&(F===i.FLOAT&&(Y=i.RG32F),F===i.HALF_FLOAT&&(Y=i.RG16F),F===i.UNSIGNED_BYTE&&(Y=i.RG8)),_===i.RG_INTEGER&&(F===i.UNSIGNED_BYTE&&(Y=i.RG8UI),F===i.UNSIGNED_SHORT&&(Y=i.RG16UI),F===i.UNSIGNED_INT&&(Y=i.RG32UI),F===i.BYTE&&(Y=i.RG8I),F===i.SHORT&&(Y=i.RG16I),F===i.INT&&(Y=i.RG32I)),_===i.RGB_INTEGER&&(F===i.UNSIGNED_BYTE&&(Y=i.RGB8UI),F===i.UNSIGNED_SHORT&&(Y=i.RGB16UI),F===i.UNSIGNED_INT&&(Y=i.RGB32UI),F===i.BYTE&&(Y=i.RGB8I),F===i.SHORT&&(Y=i.RGB16I),F===i.INT&&(Y=i.RGB32I)),_===i.RGBA_INTEGER&&(F===i.UNSIGNED_BYTE&&(Y=i.RGBA8UI),F===i.UNSIGNED_SHORT&&(Y=i.RGBA16UI),F===i.UNSIGNED_INT&&(Y=i.RGBA32UI),F===i.BYTE&&(Y=i.RGBA8I),F===i.SHORT&&(Y=i.RGBA16I),F===i.INT&&(Y=i.RGBA32I)),_===i.RGB&&F===i.UNSIGNED_INT_5_9_9_9_REV&&(Y=i.RGB9_E5),_===i.RGBA){const vt=j?Cr:Vt.getTransfer(K);F===i.FLOAT&&(Y=i.RGBA32F),F===i.HALF_FLOAT&&(Y=i.RGBA16F),F===i.UNSIGNED_BYTE&&(Y=vt===Kt?i.SRGB8_ALPHA8:i.RGBA8),F===i.UNSIGNED_SHORT_4_4_4_4&&(Y=i.RGBA4),F===i.UNSIGNED_SHORT_5_5_5_1&&(Y=i.RGB5_A1)}return(Y===i.R16F||Y===i.R32F||Y===i.RG16F||Y===i.RG32F||Y===i.RGBA16F||Y===i.RGBA32F)&&t.get("EXT_color_buffer_float"),Y}function E(y,_){let F;return y?_===null||_===Xn||_===Mi?F=i.DEPTH24_STENCIL8:_===hn?F=i.DEPTH32F_STENCIL8:_===Fi&&(F=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===Xn||_===Mi?F=i.DEPTH_COMPONENT24:_===hn?F=i.DEPTH_COMPONENT32F:_===Fi&&(F=i.DEPTH_COMPONENT16),F}function I(y,_){return p(y)===!0||y.isFramebufferTexture&&y.minFilter!==Xe&&y.minFilter!==$e?Math.log2(Math.max(_.width,_.height))+1:y.mipmaps!==void 0&&y.mipmaps.length>0?y.mipmaps.length:y.isCompressedTexture&&Array.isArray(y.image)?_.mipmaps.length:1}function b(y){const _=y.target;_.removeEventListener("dispose",b),C(_),_.isVideoTexture&&h.delete(_)}function w(y){const _=y.target;_.removeEventListener("dispose",w),x(_)}function C(y){const _=n.get(y);if(_.__webglInit===void 0)return;const F=y.source,K=f.get(F);if(K){const j=K[_.__cacheKey];j.usedTimes--,j.usedTimes===0&&S(y),Object.keys(K).length===0&&f.delete(F)}n.remove(y)}function S(y){const _=n.get(y);i.deleteTexture(_.__webglTexture);const F=y.source,K=f.get(F);delete K[_.__cacheKey],a.memory.textures--}function x(y){const _=n.get(y);if(y.depthTexture&&(y.depthTexture.dispose(),n.remove(y.depthTexture)),y.isWebGLCubeRenderTarget)for(let K=0;K<6;K++){if(Array.isArray(_.__webglFramebuffer[K]))for(let j=0;j<_.__webglFramebuffer[K].length;j++)i.deleteFramebuffer(_.__webglFramebuffer[K][j]);else i.deleteFramebuffer(_.__webglFramebuffer[K]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[K])}else{if(Array.isArray(_.__webglFramebuffer))for(let K=0;K<_.__webglFramebuffer.length;K++)i.deleteFramebuffer(_.__webglFramebuffer[K]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let K=0;K<_.__webglColorRenderbuffer.length;K++)_.__webglColorRenderbuffer[K]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[K]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const F=y.textures;for(let K=0,j=F.length;K<j;K++){const Y=n.get(F[K]);Y.__webglTexture&&(i.deleteTexture(Y.__webglTexture),a.memory.textures--),n.remove(F[K])}n.remove(y)}let R=0;function G(){R=0}function O(){const y=R;return y>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+y+" texture units while this GPU supports only "+r.maxTextures),R+=1,y}function W(y){const _=[];return _.push(y.wrapS),_.push(y.wrapT),_.push(y.wrapR||0),_.push(y.magFilter),_.push(y.minFilter),_.push(y.anisotropy),_.push(y.internalFormat),_.push(y.format),_.push(y.type),_.push(y.generateMipmaps),_.push(y.premultiplyAlpha),_.push(y.flipY),_.push(y.unpackAlignment),_.push(y.colorSpace),_.join()}function q(y,_){const F=n.get(y);if(y.isVideoTexture&&Et(y),y.isRenderTargetTexture===!1&&y.version>0&&F.__version!==y.version){const K=y.image;if(K===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(K.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Z(F,y,_);return}}e.bindTexture(i.TEXTURE_2D,F.__webglTexture,i.TEXTURE0+_)}function V(y,_){const F=n.get(y);if(y.version>0&&F.__version!==y.version){Z(F,y,_);return}e.bindTexture(i.TEXTURE_2D_ARRAY,F.__webglTexture,i.TEXTURE0+_)}function X(y,_){const F=n.get(y);if(y.version>0&&F.__version!==y.version){Z(F,y,_);return}e.bindTexture(i.TEXTURE_3D,F.__webglTexture,i.TEXTURE0+_)}function H(y,_){const F=n.get(y);if(y.version>0&&F.__version!==y.version){tt(F,y,_);return}e.bindTexture(i.TEXTURE_CUBE_MAP,F.__webglTexture,i.TEXTURE0+_)}const et={[Ni]:i.REPEAT,[Vn]:i.CLAMP_TO_EDGE,[As]:i.MIRRORED_REPEAT},rt={[Xe]:i.NEAREST,[Kc]:i.NEAREST_MIPMAP_NEAREST,[qi]:i.NEAREST_MIPMAP_LINEAR,[$e]:i.LINEAR,[Nr]:i.LINEAR_MIPMAP_NEAREST,[kn]:i.LINEAR_MIPMAP_LINEAR},ft={[Qc]:i.NEVER,[sl]:i.ALWAYS,[tl]:i.LESS,[Ko]:i.LEQUAL,[el]:i.EQUAL,[rl]:i.GEQUAL,[nl]:i.GREATER,[il]:i.NOTEQUAL};function It(y,_){if(_.type===hn&&t.has("OES_texture_float_linear")===!1&&(_.magFilter===$e||_.magFilter===Nr||_.magFilter===qi||_.magFilter===kn||_.minFilter===$e||_.minFilter===Nr||_.minFilter===qi||_.minFilter===kn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(y,i.TEXTURE_WRAP_S,et[_.wrapS]),i.texParameteri(y,i.TEXTURE_WRAP_T,et[_.wrapT]),(y===i.TEXTURE_3D||y===i.TEXTURE_2D_ARRAY)&&i.texParameteri(y,i.TEXTURE_WRAP_R,et[_.wrapR]),i.texParameteri(y,i.TEXTURE_MAG_FILTER,rt[_.magFilter]),i.texParameteri(y,i.TEXTURE_MIN_FILTER,rt[_.minFilter]),_.compareFunction&&(i.texParameteri(y,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(y,i.TEXTURE_COMPARE_FUNC,ft[_.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===Xe||_.minFilter!==qi&&_.minFilter!==kn||_.type===hn&&t.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const F=t.get("EXT_texture_filter_anisotropic");i.texParameterf(y,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,r.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function Xt(y,_){let F=!1;y.__webglInit===void 0&&(y.__webglInit=!0,_.addEventListener("dispose",b));const K=_.source;let j=f.get(K);j===void 0&&(j={},f.set(K,j));const Y=W(_);if(Y!==y.__cacheKey){j[Y]===void 0&&(j[Y]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,F=!0),j[Y].usedTimes++;const vt=j[y.__cacheKey];vt!==void 0&&(j[y.__cacheKey].usedTimes--,vt.usedTimes===0&&S(_)),y.__cacheKey=Y,y.__webglTexture=j[Y].texture}return F}function Z(y,_,F){let K=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(K=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(K=i.TEXTURE_3D);const j=Xt(y,_),Y=_.source;e.bindTexture(K,y.__webglTexture,i.TEXTURE0+F);const vt=n.get(Y);if(Y.version!==vt.__version||j===!0){e.activeTexture(i.TEXTURE0+F);const at=Vt.getPrimaries(Vt.workingColorSpace),ut=_.colorSpace===bn?null:Vt.getPrimaries(_.colorSpace),Gt=_.colorSpace===bn||at===ut?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Gt);let J=M(_.image,!1,r.maxTextureSize);J=te(_,J);const ht=s.convert(_.format,_.colorSpace),yt=s.convert(_.type);let At=T(_.internalFormat,ht,yt,_.colorSpace,_.isVideoTexture);It(K,_);let dt;const zt=_.mipmaps,Lt=_.isVideoTexture!==!0,Jt=vt.__version===void 0||j===!0,P=Y.dataReady,it=I(_,J);if(_.isDepthTexture)At=E(_.format===Si,_.type),Jt&&(Lt?e.texStorage2D(i.TEXTURE_2D,1,At,J.width,J.height):e.texImage2D(i.TEXTURE_2D,0,At,J.width,J.height,0,ht,yt,null));else if(_.isDataTexture)if(zt.length>0){Lt&&Jt&&e.texStorage2D(i.TEXTURE_2D,it,At,zt[0].width,zt[0].height);for(let k=0,$=zt.length;k<$;k++)dt=zt[k],Lt?P&&e.texSubImage2D(i.TEXTURE_2D,k,0,0,dt.width,dt.height,ht,yt,dt.data):e.texImage2D(i.TEXTURE_2D,k,At,dt.width,dt.height,0,ht,yt,dt.data);_.generateMipmaps=!1}else Lt?(Jt&&e.texStorage2D(i.TEXTURE_2D,it,At,J.width,J.height),P&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,J.width,J.height,ht,yt,J.data)):e.texImage2D(i.TEXTURE_2D,0,At,J.width,J.height,0,ht,yt,J.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){Lt&&Jt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,it,At,zt[0].width,zt[0].height,J.depth);for(let k=0,$=zt.length;k<$;k++)if(dt=zt[k],_.format!==We)if(ht!==null)if(Lt){if(P)if(_.layerUpdates.size>0){const lt=Eo(dt.width,dt.height,_.format,_.type);for(const ot of _.layerUpdates){const Rt=dt.data.subarray(ot*lt/dt.data.BYTES_PER_ELEMENT,(ot+1)*lt/dt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,k,0,0,ot,dt.width,dt.height,1,ht,Rt)}_.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,k,0,0,0,dt.width,dt.height,J.depth,ht,dt.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,k,At,dt.width,dt.height,J.depth,0,dt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Lt?P&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,k,0,0,0,dt.width,dt.height,J.depth,ht,yt,dt.data):e.texImage3D(i.TEXTURE_2D_ARRAY,k,At,dt.width,dt.height,J.depth,0,ht,yt,dt.data)}else{Lt&&Jt&&e.texStorage2D(i.TEXTURE_2D,it,At,zt[0].width,zt[0].height);for(let k=0,$=zt.length;k<$;k++)dt=zt[k],_.format!==We?ht!==null?Lt?P&&e.compressedTexSubImage2D(i.TEXTURE_2D,k,0,0,dt.width,dt.height,ht,dt.data):e.compressedTexImage2D(i.TEXTURE_2D,k,At,dt.width,dt.height,0,dt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Lt?P&&e.texSubImage2D(i.TEXTURE_2D,k,0,0,dt.width,dt.height,ht,yt,dt.data):e.texImage2D(i.TEXTURE_2D,k,At,dt.width,dt.height,0,ht,yt,dt.data)}else if(_.isDataArrayTexture)if(Lt){if(Jt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,it,At,J.width,J.height,J.depth),P)if(_.layerUpdates.size>0){const k=Eo(J.width,J.height,_.format,_.type);for(const $ of _.layerUpdates){const lt=J.data.subarray($*k/J.data.BYTES_PER_ELEMENT,($+1)*k/J.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,$,J.width,J.height,1,ht,yt,lt)}_.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,J.width,J.height,J.depth,ht,yt,J.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,At,J.width,J.height,J.depth,0,ht,yt,J.data);else if(_.isData3DTexture)Lt?(Jt&&e.texStorage3D(i.TEXTURE_3D,it,At,J.width,J.height,J.depth),P&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,J.width,J.height,J.depth,ht,yt,J.data)):e.texImage3D(i.TEXTURE_3D,0,At,J.width,J.height,J.depth,0,ht,yt,J.data);else if(_.isFramebufferTexture){if(Jt)if(Lt)e.texStorage2D(i.TEXTURE_2D,it,At,J.width,J.height);else{let k=J.width,$=J.height;for(let lt=0;lt<it;lt++)e.texImage2D(i.TEXTURE_2D,lt,At,k,$,0,ht,yt,null),k>>=1,$>>=1}}else if(zt.length>0){if(Lt&&Jt){const k=St(zt[0]);e.texStorage2D(i.TEXTURE_2D,it,At,k.width,k.height)}for(let k=0,$=zt.length;k<$;k++)dt=zt[k],Lt?P&&e.texSubImage2D(i.TEXTURE_2D,k,0,0,ht,yt,dt):e.texImage2D(i.TEXTURE_2D,k,At,ht,yt,dt);_.generateMipmaps=!1}else if(Lt){if(Jt){const k=St(J);e.texStorage2D(i.TEXTURE_2D,it,At,k.width,k.height)}P&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,ht,yt,J)}else e.texImage2D(i.TEXTURE_2D,0,At,ht,yt,J);p(_)&&l(K),vt.__version=Y.version,_.onUpdate&&_.onUpdate(_)}y.__version=_.version}function tt(y,_,F){if(_.image.length!==6)return;const K=Xt(y,_),j=_.source;e.bindTexture(i.TEXTURE_CUBE_MAP,y.__webglTexture,i.TEXTURE0+F);const Y=n.get(j);if(j.version!==Y.__version||K===!0){e.activeTexture(i.TEXTURE0+F);const vt=Vt.getPrimaries(Vt.workingColorSpace),at=_.colorSpace===bn?null:Vt.getPrimaries(_.colorSpace),ut=_.colorSpace===bn||vt===at?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ut);const Gt=_.isCompressedTexture||_.image[0].isCompressedTexture,J=_.image[0]&&_.image[0].isDataTexture,ht=[];for(let $=0;$<6;$++)!Gt&&!J?ht[$]=M(_.image[$],!0,r.maxCubemapSize):ht[$]=J?_.image[$].image:_.image[$],ht[$]=te(_,ht[$]);const yt=ht[0],At=s.convert(_.format,_.colorSpace),dt=s.convert(_.type),zt=T(_.internalFormat,At,dt,_.colorSpace),Lt=_.isVideoTexture!==!0,Jt=Y.__version===void 0||K===!0,P=j.dataReady;let it=I(_,yt);It(i.TEXTURE_CUBE_MAP,_);let k;if(Gt){Lt&&Jt&&e.texStorage2D(i.TEXTURE_CUBE_MAP,it,zt,yt.width,yt.height);for(let $=0;$<6;$++){k=ht[$].mipmaps;for(let lt=0;lt<k.length;lt++){const ot=k[lt];_.format!==We?At!==null?Lt?P&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,lt,0,0,ot.width,ot.height,At,ot.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,lt,zt,ot.width,ot.height,0,ot.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Lt?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,lt,0,0,ot.width,ot.height,At,dt,ot.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,lt,zt,ot.width,ot.height,0,At,dt,ot.data)}}}else{if(k=_.mipmaps,Lt&&Jt){k.length>0&&it++;const $=St(ht[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,it,zt,$.width,$.height)}for(let $=0;$<6;$++)if(J){Lt?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,ht[$].width,ht[$].height,At,dt,ht[$].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,zt,ht[$].width,ht[$].height,0,At,dt,ht[$].data);for(let lt=0;lt<k.length;lt++){const Rt=k[lt].image[$].image;Lt?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,lt+1,0,0,Rt.width,Rt.height,At,dt,Rt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,lt+1,zt,Rt.width,Rt.height,0,At,dt,Rt.data)}}else{Lt?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,At,dt,ht[$]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,zt,At,dt,ht[$]);for(let lt=0;lt<k.length;lt++){const ot=k[lt];Lt?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,lt+1,0,0,At,dt,ot.image[$]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,lt+1,zt,At,dt,ot.image[$])}}}p(_)&&l(i.TEXTURE_CUBE_MAP),Y.__version=j.version,_.onUpdate&&_.onUpdate(_)}y.__version=_.version}function gt(y,_,F,K,j,Y){const vt=s.convert(F.format,F.colorSpace),at=s.convert(F.type),ut=T(F.internalFormat,vt,at,F.colorSpace),Gt=n.get(_),J=n.get(F);if(J.__renderTarget=_,!Gt.__hasExternalTextures){const ht=Math.max(1,_.width>>Y),yt=Math.max(1,_.height>>Y);j===i.TEXTURE_3D||j===i.TEXTURE_2D_ARRAY?e.texImage3D(j,Y,ut,ht,yt,_.depth,0,vt,at,null):e.texImage2D(j,Y,ut,ht,yt,0,vt,at,null)}e.bindFramebuffer(i.FRAMEBUFFER,y),Bt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,K,j,J.__webglTexture,0,Ot(_)):(j===i.TEXTURE_2D||j>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&j<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,K,j,J.__webglTexture,Y),e.bindFramebuffer(i.FRAMEBUFFER,null)}function st(y,_,F){if(i.bindRenderbuffer(i.RENDERBUFFER,y),_.depthBuffer){const K=_.depthTexture,j=K&&K.isDepthTexture?K.type:null,Y=E(_.stencilBuffer,j),vt=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,at=Ot(_);Bt(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,at,Y,_.width,_.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,at,Y,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,Y,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,vt,i.RENDERBUFFER,y)}else{const K=_.textures;for(let j=0;j<K.length;j++){const Y=K[j],vt=s.convert(Y.format,Y.colorSpace),at=s.convert(Y.type),ut=T(Y.internalFormat,vt,at,Y.colorSpace),Gt=Ot(_);F&&Bt(_)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Gt,ut,_.width,_.height):Bt(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Gt,ut,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,ut,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Tt(y,_){if(_&&_.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(i.FRAMEBUFFER,y),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const K=n.get(_.depthTexture);K.__renderTarget=_,(!K.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),q(_.depthTexture,0);const j=K.__webglTexture,Y=Ot(_);if(_.depthTexture.format===pi)Bt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,j,0,Y):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,j,0);else if(_.depthTexture.format===Si)Bt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,j,0,Y):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,j,0);else throw new Error("Unknown depthTexture format")}function wt(y){const _=n.get(y),F=y.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==y.depthTexture){const K=y.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),K){const j=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,K.removeEventListener("dispose",j)};K.addEventListener("dispose",j),_.__depthDisposeCallback=j}_.__boundDepthTexture=K}if(y.depthTexture&&!_.__autoAllocateDepthBuffer){if(F)throw new Error("target.depthTexture not supported in Cube render targets");Tt(_.__webglFramebuffer,y)}else if(F){_.__webglDepthbuffer=[];for(let K=0;K<6;K++)if(e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[K]),_.__webglDepthbuffer[K]===void 0)_.__webglDepthbuffer[K]=i.createRenderbuffer(),st(_.__webglDepthbuffer[K],y,!1);else{const j=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Y=_.__webglDepthbuffer[K];i.bindRenderbuffer(i.RENDERBUFFER,Y),i.framebufferRenderbuffer(i.FRAMEBUFFER,j,i.RENDERBUFFER,Y)}}else if(e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),st(_.__webglDepthbuffer,y,!1);else{const K=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,j=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,j),i.framebufferRenderbuffer(i.FRAMEBUFFER,K,i.RENDERBUFFER,j)}e.bindFramebuffer(i.FRAMEBUFFER,null)}function Nt(y,_,F){const K=n.get(y);_!==void 0&&gt(K.__webglFramebuffer,y,y.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),F!==void 0&&wt(y)}function re(y){const _=y.texture,F=n.get(y),K=n.get(_);y.addEventListener("dispose",w);const j=y.textures,Y=y.isWebGLCubeRenderTarget===!0,vt=j.length>1;if(vt||(K.__webglTexture===void 0&&(K.__webglTexture=i.createTexture()),K.__version=_.version,a.memory.textures++),Y){F.__webglFramebuffer=[];for(let at=0;at<6;at++)if(_.mipmaps&&_.mipmaps.length>0){F.__webglFramebuffer[at]=[];for(let ut=0;ut<_.mipmaps.length;ut++)F.__webglFramebuffer[at][ut]=i.createFramebuffer()}else F.__webglFramebuffer[at]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){F.__webglFramebuffer=[];for(let at=0;at<_.mipmaps.length;at++)F.__webglFramebuffer[at]=i.createFramebuffer()}else F.__webglFramebuffer=i.createFramebuffer();if(vt)for(let at=0,ut=j.length;at<ut;at++){const Gt=n.get(j[at]);Gt.__webglTexture===void 0&&(Gt.__webglTexture=i.createTexture(),a.memory.textures++)}if(y.samples>0&&Bt(y)===!1){F.__webglMultisampledFramebuffer=i.createFramebuffer(),F.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let at=0;at<j.length;at++){const ut=j[at];F.__webglColorRenderbuffer[at]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,F.__webglColorRenderbuffer[at]);const Gt=s.convert(ut.format,ut.colorSpace),J=s.convert(ut.type),ht=T(ut.internalFormat,Gt,J,ut.colorSpace,y.isXRRenderTarget===!0),yt=Ot(y);i.renderbufferStorageMultisample(i.RENDERBUFFER,yt,ht,y.width,y.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+at,i.RENDERBUFFER,F.__webglColorRenderbuffer[at])}i.bindRenderbuffer(i.RENDERBUFFER,null),y.depthBuffer&&(F.__webglDepthRenderbuffer=i.createRenderbuffer(),st(F.__webglDepthRenderbuffer,y,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(Y){e.bindTexture(i.TEXTURE_CUBE_MAP,K.__webglTexture),It(i.TEXTURE_CUBE_MAP,_);for(let at=0;at<6;at++)if(_.mipmaps&&_.mipmaps.length>0)for(let ut=0;ut<_.mipmaps.length;ut++)gt(F.__webglFramebuffer[at][ut],y,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+at,ut);else gt(F.__webglFramebuffer[at],y,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+at,0);p(_)&&l(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(vt){for(let at=0,ut=j.length;at<ut;at++){const Gt=j[at],J=n.get(Gt);e.bindTexture(i.TEXTURE_2D,J.__webglTexture),It(i.TEXTURE_2D,Gt),gt(F.__webglFramebuffer,y,Gt,i.COLOR_ATTACHMENT0+at,i.TEXTURE_2D,0),p(Gt)&&l(i.TEXTURE_2D)}e.unbindTexture()}else{let at=i.TEXTURE_2D;if((y.isWebGL3DRenderTarget||y.isWebGLArrayRenderTarget)&&(at=y.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(at,K.__webglTexture),It(at,_),_.mipmaps&&_.mipmaps.length>0)for(let ut=0;ut<_.mipmaps.length;ut++)gt(F.__webglFramebuffer[ut],y,_,i.COLOR_ATTACHMENT0,at,ut);else gt(F.__webglFramebuffer,y,_,i.COLOR_ATTACHMENT0,at,0);p(_)&&l(at),e.unbindTexture()}y.depthBuffer&&wt(y)}function Ht(y){const _=y.textures;for(let F=0,K=_.length;F<K;F++){const j=_[F];if(p(j)){const Y=A(y),vt=n.get(j).__webglTexture;e.bindTexture(Y,vt),l(Y),e.unbindTexture()}}}const ae=[],U=[];function Le(y){if(y.samples>0){if(Bt(y)===!1){const _=y.textures,F=y.width,K=y.height;let j=i.COLOR_BUFFER_BIT;const Y=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,vt=n.get(y),at=_.length>1;if(at)for(let ut=0;ut<_.length;ut++)e.bindFramebuffer(i.FRAMEBUFFER,vt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ut,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,vt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ut,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,vt.__webglMultisampledFramebuffer),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,vt.__webglFramebuffer);for(let ut=0;ut<_.length;ut++){if(y.resolveDepthBuffer&&(y.depthBuffer&&(j|=i.DEPTH_BUFFER_BIT),y.stencilBuffer&&y.resolveStencilBuffer&&(j|=i.STENCIL_BUFFER_BIT)),at){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,vt.__webglColorRenderbuffer[ut]);const Gt=n.get(_[ut]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Gt,0)}i.blitFramebuffer(0,0,F,K,0,0,F,K,j,i.NEAREST),c===!0&&(ae.length=0,U.length=0,ae.push(i.COLOR_ATTACHMENT0+ut),y.depthBuffer&&y.resolveDepthBuffer===!1&&(ae.push(Y),U.push(Y),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,U)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,ae))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),at)for(let ut=0;ut<_.length;ut++){e.bindFramebuffer(i.FRAMEBUFFER,vt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ut,i.RENDERBUFFER,vt.__webglColorRenderbuffer[ut]);const Gt=n.get(_[ut]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,vt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ut,i.TEXTURE_2D,Gt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,vt.__webglMultisampledFramebuffer)}else if(y.depthBuffer&&y.resolveDepthBuffer===!1&&c){const _=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function Ot(y){return Math.min(r.maxSamples,y.samples)}function Bt(y){const _=n.get(y);return y.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function Et(y){const _=a.render.frame;h.get(y)!==_&&(h.set(y,_),y.update())}function te(y,_){const F=y.colorSpace,K=y.format,j=y.type;return y.isCompressedTexture===!0||y.isVideoTexture===!0||F!==yi&&F!==bn&&(Vt.getTransfer(F)===Kt?(K!==We||j!==mn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",F)),_}function St(y){return typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement?(u.width=y.naturalWidth||y.width,u.height=y.naturalHeight||y.height):typeof VideoFrame<"u"&&y instanceof VideoFrame?(u.width=y.displayWidth,u.height=y.displayHeight):(u.width=y.width,u.height=y.height),u}this.allocateTextureUnit=O,this.resetTextureUnits=G,this.setTexture2D=q,this.setTexture2DArray=V,this.setTexture3D=X,this.setTextureCube=H,this.rebindTextures=Nt,this.setupRenderTarget=re,this.updateRenderTargetMipmap=Ht,this.updateMultisampleRenderTarget=Le,this.setupDepthRenderbuffer=wt,this.setupFrameBufferTexture=gt,this.useMultisampledRTT=Bt}function hp(i,t){function e(n,r=bn){let s;const a=Vt.getTransfer(r);if(n===mn)return i.UNSIGNED_BYTE;if(n===ra)return i.UNSIGNED_SHORT_4_4_4_4;if(n===sa)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Ho)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Bo)return i.BYTE;if(n===zo)return i.SHORT;if(n===Fi)return i.UNSIGNED_SHORT;if(n===ia)return i.INT;if(n===Xn)return i.UNSIGNED_INT;if(n===hn)return i.FLOAT;if(n===Bi)return i.HALF_FLOAT;if(n===Go)return i.ALPHA;if(n===Vo)return i.RGB;if(n===We)return i.RGBA;if(n===ko)return i.LUMINANCE;if(n===Wo)return i.LUMINANCE_ALPHA;if(n===pi)return i.DEPTH_COMPONENT;if(n===Si)return i.DEPTH_STENCIL;if(n===Xo)return i.RED;if(n===aa)return i.RED_INTEGER;if(n===qo)return i.RG;if(n===oa)return i.RG_INTEGER;if(n===ca)return i.RGBA_INTEGER;if(n===mr||n===_r||n===gr||n===vr)if(a===Kt)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===mr)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===_r)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===gr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===vr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===mr)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===_r)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===gr)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===vr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===bs||n===ws||n===Rs||n===Cs)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===bs)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===ws)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Rs)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Cs)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Ps||n===Ls||n===Ds)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Ps||n===Ls)return a===Kt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Ds)return a===Kt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Us||n===Is||n===Ns||n===Fs||n===Os||n===Bs||n===zs||n===Hs||n===Gs||n===Vs||n===ks||n===Ws||n===Xs||n===qs)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Us)return a===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Is)return a===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Ns)return a===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Fs)return a===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Os)return a===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Bs)return a===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===zs)return a===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Hs)return a===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Gs)return a===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Vs)return a===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===ks)return a===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Ws)return a===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Xs)return a===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===qs)return a===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===xr||n===Ys||n===Zs)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(n===xr)return a===Kt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Ys)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Zs)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Yo||n===Ks||n===$s||n===js)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(n===xr)return s.COMPRESSED_RED_RGTC1_EXT;if(n===Ks)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===$s)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===js)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Mi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}class dp extends Ae{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class Fe extends ve{constructor(){super(),this.isGroup=!0,this.type="Group"}}const fp={type:"move"};class us{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Fe,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Fe,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new N,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new N),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Fe,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new N,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new N),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let r=null,s=null,a=null;const o=this._targetRay,c=this._grip,u=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(u&&t.hand){a=!0;for(const M of t.hand.values()){const p=e.getJointPose(M,n),l=this._getHandJoint(u,M);p!==null&&(l.matrix.fromArray(p.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,l.jointRadius=p.radius),l.visible=p!==null}const h=u.joints["index-finger-tip"],d=u.joints["thumb-tip"],f=h.position.distanceTo(d.position),m=.02,g=.005;u.inputState.pinching&&f>m+g?(u.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!u.inputState.pinching&&f<=m-g&&(u.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else c!==null&&t.gripSpace&&(s=e.getPose(t.gripSpace,n),s!==null&&(c.matrix.fromArray(s.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,s.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(s.linearVelocity)):c.hasLinearVelocity=!1,s.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(s.angularVelocity)):c.hasAngularVelocity=!1));o!==null&&(r=e.getPose(t.targetRaySpace,n),r===null&&s!==null&&(r=s),r!==null&&(o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,r.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(r.linearVelocity)):o.hasLinearVelocity=!1,r.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(r.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(fp)))}return o!==null&&(o.visible=r!==null),c!==null&&(c.visible=s!==null),u!==null&&(u.visible=a!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const n=new Fe;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}}const pp=`
void main() {
...
}`;class _p{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,n){if(this.texture===null){const r=new Me,s=t.properties.get(r);s.__webglTexture=e.texture,(e.depthNear!=n.depthNear||e.depthFar!=n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=r}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,n=new Pn({vertexShader:pp,fragmentShader:mp,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new Mt(new fe(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class gp extends Yn{constructor(t,e){super();const n=this;let r=null,s=1,a=null,o="local-floor",c=1,u=null,h=null,d=null,f=null,m=null,g=null;const M=new _p,p=e.getContextAttributes();let l=null,A=null;const T=[],E=[],I=new Wt;let b=null;const w=new Ae;w.viewport=new $t;const C=new Ae;C.viewport=new $t;const S=[w,C],x=new dp;let R=null,G=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Z){let tt=T[Z];return tt===void 0&&(tt=new us,T[Z]=tt),tt.getTargetRaySpace()},this.getControllerGrip=function(Z){let tt=T[Z];return tt===void 0&&(tt=new us,T[Z]=tt),tt.getGripSpace()},this.getHand=function(Z){let tt=T[Z];return tt===void 0&&(tt=new us,T[Z]=tt),tt.getHandSpace()};function O(Z){const tt=E.indexOf(Z.inputSource);if(tt===-1)return;const gt=T[tt];gt!==void 0&&(gt.update(Z.inputSource,Z.frame,u||a),gt.dispatchEvent({type:Z.type,data:Z.inputSource}))}function W(){r.removeEventListener("select",O),r.removeEventListener("selectstart",O),r.removeEventListener("selectend",O),r.removeEventListener("squeeze",O),r.removeEventListener("squeezestart",O),r.removeEventListener("squeezeend",O),r.removeEventListener("end",W),r.removeEventListener("inputsourceschange",q);for(let Z=0;Z<T.length;Z++){const tt=E[Z];tt!==null&&(E[Z]=null,T[Z].disconnect(tt))}R=null,G=null,M.reset(),t.setRenderTarget(l),m=null,f=null,d=null,r=null,A=null,Xt.stop(),n.isPresenting=!1,t.setPixelRatio(b),t.setSize(I.width,I.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Z){s=Z,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Z){o=Z,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return u||a},this.setReferenceSpace=function(Z){u=Z},this.getBaseLayer=function(){return f!==null?f:m},this.getBinding=function(){return d},this.getFrame=function(){return g},this.getSession=function(){return r},this.setSession=async function(Z){if(r=Z,r!==null){if(l=t.getRenderTarget(),r.addEventListener("select",O),r.addEventListener("selectstart",O),r.addEventListener("selectend",O),r.addEventListener("squeeze",O),r.addEventListener("squeezestart",O),r.addEventListener("squeezeend",O),r.addEventListener("end",W),r.addEventListener("inputsourceschange",q),p.xrCompatible!==!0&&await e.makeXRCompatible(),b=t.getPixelRatio(),t.getSize(I),r.renderState.layers===void 0){const tt={antialias:p.antialias,alpha:!0,depth:p.depth,stencil:p.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,e,tt),r.updateRenderState({baseLayer:m}),t.setPixelRatio(1),t.setSize(m.framebufferWidth,m.framebufferHeight,!1),A=new qn(m.framebufferWidth,m.framebufferHeight,{format:We,type:mn,colorSpace:t.outputColorSpace,stencilBuffer:p.stencil})}else{let tt=null,gt=null,st=null;p.depth&&(st=p.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,tt=p.stencil?Si:pi,gt=p.stencil?Mi:Xn);const Tt={colorFormat:e.RGBA8,depthFormat:st,scaleFactor:s};d=new XRWebGLBinding(r,e),f=d.createProjectionLayer(Tt),r.updateRenderState({layers:[f]}),t.setPixelRatio(1),t.setSize(f.textureWidth,f.textureHeight,!1),A=new qn(f.textureWidth,f.textureHeight,{format:We,type:mn,depthTexture:new oc(f.textureWidth,f.textureHeight,gt,void 0,void 0,void 0,void 0,void 0,void 0,tt),stencilBuffer:p.stencil,colorSpace:t.outputColorSpace,samples:p.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1})}A.isXRRenderTarget=!0,this.setFoveation(c),u=null,a=await r.requestReferenceSpace(o),Xt.setContext(r),Xt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return M.getDepthTexture()};function q(Z){for(let tt=0;tt<Z.removed.length;tt++){const gt=Z.removed[tt],st=E.indexOf(gt);st>=0&&(E[st]=null,T[st].disconnect(gt))}for(let tt=0;tt<Z.added.length;tt++){const gt=Z.added[tt];let st=E.indexOf(gt);if(st===-1){for(let wt=0;wt<T.length;wt++)if(wt>=E.length){E.push(gt),st=wt;break}else if(E[wt]===null){E[wt]=gt,st=wt;break}if(st===-1)break}const Tt=T[st];Tt&&Tt.connect(gt)}}const V=new N,X=new N;function H(Z,tt,gt){V.setFromMatrixPosition(tt.matrixWorld),X.setFromMatrixPosition(gt.matrixWorld);const st=V.distanceTo(X),Tt=tt.projectionMatrix.elements,wt=gt.projectionMatrix.elements,Nt=Tt[14]/(Tt[10]-1),re=Tt[14]/(Tt[10]+1),Ht=(Tt[9]+1)/Tt[5],ae=(Tt[9]-1)/Tt[5],U=(Tt[8]-1)/Tt[0],Le=(wt[8]+1)/wt[0],Ot=Nt*U,Bt=Nt*Le,Et=st/(-U+Le),te=Et*-U;if(tt.matrixWorld.decompose(Z.position,Z.quaternion,Z.scale),Z.translateX(te),Z.translateZ(Et),Z.matrixWorld.compose(Z.position,Z.quaternion,Z.scale),Z.matrixWorldInverse.copy(Z.matrixWorld).invert(),Tt[10]===-1)Z.projectionMatrix.copy(tt.projectionMatrix),Z.projectionMatrixInverse.copy(tt.projectionMatrixInverse);else{const St=Nt+Et,y=re+Et,_=Ot-te,F=Bt+(st-te),K=Ht*re/y*St,j=ae*re/y*St;Z.projectionMatrix.makePerspective(_,F,K,j,St,y),Z.projectionMatrixInverse.copy(Z.projectionMatrix).invert()}}function et(Z,tt){tt===null?Z.matrixWorld.copy(Z.matrix):Z.matrixWorld.multiplyMatrices(tt.matrixWorld,Z.matrix),Z.matrixWorldInverse.copy(Z.matrixWorld).invert()}this.updateCamera=function(Z){if(r===null)return;let tt=Z.near,gt=Z.far;M.texture!==null&&(M.depthNear>0&&(tt=M.depthNear),M.depthFar>0&&(gt=M.depthFar)),x.near=C.near=w.near=tt,x.far=C.far=w.far=gt,(R!==x.near||G!==x.far)&&(r.updateRenderState({depthNear:x.near,depthFar:x.far}),R=x.near,G=x.far),w.layers.mask=Z.layers.mask|2,C.layers.mask=Z.layers.mask|4,x.layers.mask=w.layers.mask|C.layers.mask;const st=Z.parent,Tt=x.cameras;et(x,st);for(let wt=0;wt<Tt.length;wt++)et(Tt[wt],st);Tt.length===2?H(x,w,C):x.projectionMatrix.copy(w.projectionMatrix),rt(Z,x,st)};function rt(Z,tt,gt){gt===null?Z.matrix.copy(tt.matrixWorld):(Z.matrix.copy(gt.matrixWorld),Z.matrix.invert(),Z.matrix.multiply(tt.matrixWorld)),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale),Z.updateMatrixWorld(!0),Z.projectionMatrix.copy(tt.projectionMatrix),Z.projectionMatrixInverse.copy(tt.projectionMatrixInverse),Z.isPerspectiveCamera&&(Z.fov=br*2*Math.atan(1/Z.projectionMatrix.elements[5]),Z.zoom=1)}this.getCamera=function(){return x},this.getFoveation=function(){if(!(f===null&&m===null))return c},this.setFoveation=function(Z){c=Z,f!==null&&(f.fixedFoveation=Z),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=Z)},this.hasDepthSensing=function(){return M.texture!==null},this.getDepthSensingMesh=function(){return M.getMesh(x)};let ft=null;function It(Z,tt){if(h=tt.getViewerPose(u||a),g=tt,h!==null){const gt=h.views;m!==null&&(t.setRenderTargetFramebuffer(A,m.framebuffer),t.setRenderTarget(A));let st=!1;gt.length!==x.cameras.length&&(x.cameras.length=0,st=!0);for(let wt=0;wt<gt.length;wt++){const Nt=gt[wt];let re=null;if(m!==null)re=m.getViewport(Nt);else{const ae=d.getViewSubImage(f,Nt);re=ae.viewport,wt===0&&(t.setRenderTargetTextures(A,ae.colorTexture,f.ignoreDepthValues?void 0:ae.depthStencilTexture),t.setRenderTarget(A))}let Ht=S[wt];Ht===void 0&&(Ht=new Ae,Ht.layers.enable(wt),Ht.viewport=new $t,S[wt]=Ht),Ht.matrix.fromArray(Nt.transform.matrix),Ht.matrix.decompose(Ht.position,Ht.quaternion,Ht.scale),Ht.projectionMatrix.fromArray(Nt.projectionMatrix),Ht.projectionMatrixInverse.copy(Ht.projectionMatrix).invert(),Ht.viewport.set(re.x,re.y,re.width,re.height),wt===0&&(x.matrix.copy(Ht.matrix),x.matrix.decompose(x.position,x.quaternion,x.scale)),st===!0&&x.cameras.push(Ht)}const Tt=r.enabledFeatures;if(Tt&&Tt.includes("depth-sensing")){const wt=d.getDepthInformation(gt[0]);wt&&wt.isValid&&wt.texture&&M.init(t,wt,r.renderState)}}for(let gt=0;gt<T.length;gt++){const st=E[gt],Tt=T[gt];st!==null&&Tt!==void 0&&Tt.update(st,tt,u||a)}ft&&ft(Z,tt),tt.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:tt}),g=null}const Xt=new ac;Xt.setAnimationLoop(It),this.setAnimationLoop=function(Z){ft=Z},this.dispose=function(){}}}const On=new qe,vp=new ie;function xp(i,t){function e(p,l){p.matrixAutoUpdate===!0&&p.updateMatrix(),l.value.copy(p.matrix)}function n(p,l){l.color.getRGB(p.fogColor.value,ic(i)),l.isFog?(p.fogNear.value=l.near,p.fogFar.value=l.far):l.isFogExp2&&(p.fogDensity.value=l.density)}function r(p,l,A,T,E){l.isMeshBasicMaterial||l.isMeshLambertMaterial?s(p,l):l.isMeshToonMaterial?(s(p,l),d(p,l)):l.isMeshPhongMaterial?(s(p,l),h(p,l)):l.isMeshStandardMaterial?(s(p,l),f(p,l),l.isMeshPhysicalMaterial&&m(p,l,E)):l.isMeshMatcapMaterial?(s(p,l),g(p,l)):l.isMeshDepthMaterial?s(p,l):l.isMeshDistanceMaterial?(s(p,l),M(p,l)):l.isMeshNormalMaterial?s(p,l):l.isLineBasicMaterial?(a(p,l),l.isLineDashedMaterial&&o(p,l)):l.isPointsMaterial?c(p,l,A,T):l.isSpriteMaterial?u(p,l):l.isShadowMaterial?(p.color.value.copy(l.color),p.opacity.value=l.opacity):l.isShaderMaterial&&(l.uniformsNeedUpdate=!1)}function s(p,l){p.opacity.value=l.opacity,l.color&&p.diffuse.value.copy(l.color),l.emissive&&p.emissive.value.copy(l.emissive).multiplyScalar(l.emissiveIntensity),l.map&&(p.map.value=l.map,e(l.map,p.mapTransform)),l.alphaMap&&(p.alphaMap.value=l.alphaMap,e(l.alphaMap,p.alphaMapTransform)),l.bumpMap&&(p.bumpMap.value=l.bumpMap,e(l.bumpMap,p.bumpMapTransform),p.bumpScale.value=l.bumpScale,l.side===be&&(p.bumpScale.value*=-1)),l.normalMap&&(p.normalMap.value=l.normalMap,e(l.normalMap,p.normalMapTransform),p.normalScale.value.copy(l.normalScale),l.side===be&&p.normalScale.value.negate()),l.displacementMap&&(p.displacementMap.value=l.displacementMap,e(l.displacementMap,p.displacementMapTransform),p.displacementScale.value=l.displacementScale,p.displacementBias.value=l.displacementBias),l.emissiveMap&&(p.emissiveMap.value=l.emissiveMap,e(l.emissiveMap,p.emissiveMapTransform)),l.specularMap&&(p.specularMap.value=l.specularMap,e(l.specularMap,p.specularMapTransform)),l.alphaTest>0&&(p.alphaTest.value=l.alphaTest);const A=t.get(l),T=A.envMap,E=A.envMapRotation;T&&(p.envMap.value=T,On.copy(E),On.x*=-1,On.y*=-1,On.z*=-1,T.isCubeTexture&&T.isRenderTargetTexture===!1&&(On.y*=-1,On.z*=-1),p.envMapRotation.value.setFromMatrix4(vp.makeRotationFromEuler(On)),p.flipEnvMap.value=T.isCubeTexture&&T.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=l.reflectivity,p.ior.value=l.ior,p.refractionRatio.value=l.refractionRatio),l.lightMap&&(p.lightMap.value=l.lightMap,p.lightMapIntensity.value=l.lightMapIntensity,e(l.lightMap,p.lightMapTransform)),l.aoMap&&(p.aoMap.value=l.aoMap,p.aoMapIntensity.value=l.aoMapIntensity,e(l.aoMap,p.aoMapTransform))}function a(p,l){p.diffuse.value.copy(l.color),p.opacity.value=l.opacity,l.map&&(p.map.value=l.map,e(l.map,p.mapTransform))}function o(p,l){p.dashSize.value=l.dashSize,p.totalSize.value=l.dashSize+l.gapSize,p.scale.value=l.scale}function c(p,l,A,T){p.diffuse.value.copy(l.color),p.opacity.value=l.opacity,p.size.value=l.size*A,p.scale.value=T*.5,l.map&&(p.map.value=l.map,e(l.map,p.uvTransform)),l.alphaMap&&(p.alphaMap.value=l.alphaMap,e(l.alphaMap,p.alphaMapTransform)),l.alphaTest>0&&(p.alphaTest.value=l.alphaTest)}function u(p,l){p.diffuse.value.copy(l.color),p.opacity.value=l.opacity,p.rotation.value=l.rotation,l.map&&(p.map.value=l.map,e(l.map,p.mapTransform)),l.alphaMap&&(p.alphaMap.value=l.alphaMap,e(l.alphaMap,p.alphaMapTransform)),l.alphaTest>0&&(p.alphaTest.value=l.alphaTest)}function h(p,l){p.specular.value.copy(l.specular),p.shininess.value=Math.max(l.shininess,1e-4)}function d(p,l){l.gradientMap&&(p.gradientMap.value=l.gradientMap)}function f(p,l){p.metalness.value=l.metalness,l.metalnessMap&&(p.metalnessMap.value=l.metalnessMap,e(l.metalnessMap,p.metalnessMapTransform)),p.roughness.value=l.roughness,l.roughnessMap&&(p.roughnessMap.value=l.roughnessMap,e(l.roughnessMap,p.roughnessMapTransform)),l.envMap&&(p.envMapIntensity.value=l.envMapIntensity)}function m(p,l,A){p.ior.value=l.ior,l.sheen>0&&(p.sheenColor.value.copy(l.sheenColor).multiplyScalar(l.sheen),p.sheenRoughness.value=l.sheenRoughness,l.sheenColorMap&&(p.sheenColorMap.value=l.sheenColorMap,e(l.sheenColorMap,p.sheenColorMapTransform)),l.sheenRoughnessMap&&(p.sheenRoughnessMap.value=l.sheenRoughnessMap,e(l.sheenRoughnessMap,p.sheenRoughnessMapTransform))),l.clearcoat>0&&(p.clearcoat.value=l.clearcoat,p.clearcoatRoughness.value=l.clearcoatRoughness,l.clearcoatMap&&(p.clearcoatMap.value=l.clearcoatMap,e(l.clearcoatMap,p.clearcoatMapTransform)),l.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=l.clearcoatRoughnessMap,e(l.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),l.clearcoatNormalMap&&(p.clearcoatNormalMap.value=l.clearcoatNormalMap,e(l.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(l.clearcoatNormalScale),l.side===be&&p.clearcoatNormalScale.value.negate())),l.dispersion>0&&(p.dispersion.value=l.dispersion),l.iridescence>0&&(p.iridescence.value=l.iridescence,p.iridescenceIOR.value=l.iridescenceIOR,p.iridescenceThicknessMinimum.value=l.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=l.iridescenceThicknessRange[1],l.iridescenceMap&&(p.iridescenceMap.value=l.iridescenceMap,e(l.iridescenceMap,p.iridescenceMapTransform)),l.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=l.iridescenceThicknessMap,e(l.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),l.transmission>0&&(p.transmission.value=l.transmission,p.transmissionSamplerMap.value=A.texture,p.transmissionSamplerSize.value.set(A.width,A.height),l.transmissionMap&&(p.transmissionMap.value=l.transmissionMap,e(l.transmissionMap,p.transmissionMapTransform)),p.thickness.value=l.thickness,l.thicknessMap&&(p.thicknessMap.value=l.thicknessMap,e(l.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=l.attenuationDistance,p.attenuationColor.value.copy(l.attenuationColor)),l.anisotropy>0&&(p.anisotropyVector.value.set(l.anisotropy*Math.cos(l.anisotropyRotation),l.anisotropy*Math.sin(l.anisotropyRotation)),l.anisotropyMap&&(p.anisotropyMap.value=l.anisotropyMap,e(l.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=l.specularIntensity,p.specularColor.value.copy(l.specularColor),l.specularColorMap&&(p.specularColorMap.value=l.specularColorMap,e(l.specularColorMap,p.specularColorMapTransform)),l.specularIntensityMap&&(p.specularIntensityMap.value=l.specularIntensityMap,e(l.specularIntensityMap,p.specularIntensityMapTransform))}function g(p,l){l.matcap&&(p.matcap.value=l.matcap)}function M(p,l){const A=t.get(l).light;p.referencePosition.value.setFromMatrixPosition(A.matrixWorld),p.nearDistance.value=A.shadow.camera.near,p.farDistance.value=A.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function Mp(i,t,e,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(A,T){const E=T.program;n.uniformBlockBinding(A,E)}function u(A,T){let E=r[A.id];E===void 0&&(g(A),E=h(A),r[A.id]=E,A.addEventListener("dispose",p));const I=T.program;n.updateUBOMapping(A,I);const b=t.render.frame;s[A.id]!==b&&(f(A),s[A.id]=b)}function h(A){const T=d();A.__bindingPointIndex=T;const E=i.createBuffer(),I=A.__size,b=A.usage;return i.bindBuffer(i.UNIFORM_BUFFER,E),i.bufferData(i.UNIFORM_BUFFER,I,b),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,T,E),E}function d(){for(let A=0;A<o;A++)if(a.indexOf(A)===-1)return a.push(A),A;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(A){const T=r[A.id],E=A.uniforms,I=A.__cache;i.bindBuffer(i.UNIFORM_BUFFER,T);for(let b=0,w=E.length;b<w;b++){const C=Array.isArray(E[b])?E[b]:[E[b]];for(let S=0,x=C.length;S<x;S++){const R=C[S];if(m(R,b,S,I)===!0){const G=R.__offset,O=Array.isArray(R.value)?R.value:[R.value];let W=0;for(let q=0;q<O.length;q++){const V=O[q],X=M(V);typeof V=="number"||typeof V=="boolean"?(R.__data[0]=V,i.bufferSubData(i.UNIFORM_BUFFER,G+W,R.__data)):V.isMatrix3?(R.__data[0]=V.elements[0],R.__data[1]=V.elements[1],R.__data[2]=V.elements[2],R.__data[3]=0,R.__data[4]=V.elements[3],R.__data[5]=V.elements[4],R.__data[6]=V.elements[5],R.__data[7]=0,R.__data[8]=V.elements[6],R.__data[9]=V.elements[7],R.__data[10]=V.elements[8],R.__data[11]=0):(V.toArray(R.__data,W),W+=X.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,G,R.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function m(A,T,E,I){const b=A.value,w=T+"_"+E;if(I[w]===void 0)return typeof b=="number"||typeof b=="boolean"?I[w]=b:I[w]=b.clone(),!0;{const C=I[w];if(typeof b=="number"||typeof b=="boolean"){if(C!==b)return I[w]=b,!0}else if(C.equals(b)===!1)return C.copy(b),!0}return!1}function g(A){const T=A.uniforms;let E=0;const I=16;for(let w=0,C=T.length;w<C;w++){const S=Array.isArray(T[w])?T[w]:[T[w]];for(let x=0,R=S.length;x<R;x++){const G=S[x],O=Array.isArray(G.value)?G.value:[G.value];for(let W=0,q=O.length;W<q;W++){const V=O[W],X=M(V),H=E%I,et=H%X.boundary,rt=H+et;E+=et,rt!==0&&I-rt<X.storage&&(E+=I-rt),G.__data=new Float32Array(X.storage/Float32Array.BYTES_PER_ELEMENT),G.__offset=E,E+=X.storage}}}const b=E%I;return b>0&&(E+=I-b),A.__size=E,A.__cache={},this}function M(A){const T={boundary:0,storage:0};return typeof A=="number"||typeof A=="boolean"?(T.boundary=4,T.storage=4):A.isVector2?(T.boundary=8,T.storage=8):A.isVector3||A.isColor?(T.boundary=16,T.storage=12):A.isVector4?(T.boundary=16,T.storage=16):A.isMatrix3?(T.boundary=48,T.storage=48):A.isMatrix4?(T.boundary=64,T.storage=64):A.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",A),T}function p(A){const T=A.target;T.removeEventListener("dispose",p);const E=a.indexOf(T.__bindingPointIndex);a.splice(E,1),i.deleteBuffer(r[T.id]),delete r[T.id],delete s[T.id]}function l(){for(const A in r)i.deleteBuffer(r[A]);a=[],r={},s={}}return{bind:c,update:u,dispose:l}}class Sp{constructor(t={}){const{canvas:e=ol(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:u=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:d=!1,reverseDepthBuffer:f=!1}=t;this.isWebGLRenderer=!0;let m;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");m=n.getContextAttributes().alpha}else m=a;const g=new Uint32Array(4),M=new Int32Array(4);let p=null,l=null;const A=[],T=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Ie,this.toneMapping=Rn,this.toneMappingExposure=1;const E=this;let I=!1,b=0,w=0,C=null,S=-1,x=null;const R=new $t,G=new $t;let O=null;const W=new Ft(0);let q=0,V=e.width,X=e.height,H=1,et=null,rt=null;const ft=new $t(0,0,V,X),It=new $t(0,0,V,X);let Xt=!1;const Z=new ha;let tt=!1,gt=!1;const st=new ie,Tt=new ie,wt=new N,Nt=new $t,re={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Ht=!1;function ae(){return C===null?H:1}let U=n;function Le(v,L){return e.getContext(v,L)}try{const v={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:u,powerPreference:h,failIfMajorPerformanceCaveat:d};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${na}`),e.addEventListener("webglcontextlost",$,!1),e.addEventListener("webglcontextrestored",lt,!1),e.addEventListener("webglcontextcreationerror",ot,!1),U===null){const L="webgl2";if(U=Le(L,v),U===null)throw Le(L)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(v){throw console.error("THREE.WebGLRenderer: "+v.message),v}let Ot,Bt,Et,te,St,y,_,F,K,j,Y,vt,at,ut,Gt,J,ht,yt,At,dt,zt,Lt,Jt,P;function it(){Ot=new Ad(U),Ot.init(),Lt=new hp(U,Ot),Bt=new vd(U,Ot,t,Lt),Et=new cp(U,Ot),Bt.reverseDepthBuffer&&f&&Et.buffers.depth.setReversed(!0),te=new Rd(U),St=new Yf,y=new up(U,Ot,Et,St,Bt,Lt,te),_=new Md(E),F=new Td(E),K=new Il(U),Jt=new _d(U,K),j=new bd(U,K,te,Jt),Y=new Pd(U,j,K,te),At=new Cd(U,Bt,y),J=new xd(St),vt=new qf(E,_,F,Ot,Bt,Jt,J),at=new xp(E,St),ut=new Kf,Gt=new ep(Ot),yt=new md(E,_,F,Et,Y,m,c),ht=new ap(E,Y,Bt),P=new Mp(U,te,Bt,Et),dt=new gd(U,Ot,te),zt=new wd(U,Ot,te),te.programs=vt.programs,E.capabilities=Bt,E.extensions=Ot,E.properties=St,E.renderLists=ut,E.shadowMap=ht,E.state=Et,E.info=te}it();const k=new gp(E,U);this.xr=k,this.getContext=function(){return U},this.getContextAttributes=function(){return U.getContextAttributes()},this.forceContextLoss=function(){const v=Ot.get("WEBGL_lose_context");v&&v.loseContext()},this.forceContextRestore=function(){const v=Ot.get("WEBGL_lose_context");v&&v.restoreContext()},this.getPixelRatio=function(){return H},this.setPixelRatio=function(v){v!==void 0&&(H=v,this.setSize(V,X,!1))},this.getSize=function(v){return v.set(V,X)},this.setSize=function(v,L,B=!0){if(k.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}V=v,X=L,e.width=Math.floor(v*H),e.height=Math.floor(L*H),B===!0&&(e.style.width=v+"px",e.style.height=L+"px"),this.setViewport(0,0,v,L)},this.getDrawingBufferSize=function(v){return v.set(V*H,X*H).floor()},this.setDrawingBufferSize=function(v,L,B){V=v,X=L,H=B,e.width=Math.floor(v*B),e.height=Math.floor(L*B),this.setViewport(0,0,v,L)},this.getCurrentViewport=function(v){return v.copy(R)},this.getViewport=function(v){return v.copy(ft)},this.setViewport=function(v,L,B,z){v.isVector4?ft.set(v.x,v.y,v.z,v.w):ft.set(v,L,B,z),Et.viewport(R.copy(ft).multiplyScalar(H).round())},this.getScissor=function(v){return v.copy(It)},this.setScissor=function(v,L,B,z){v.isVector4?It.set(v.x,v.y,v.z,v.w):It.set(v,L,B,z),Et.scissor(G.copy(It).multiplyScalar(H).round())},this.getScissorTest=function(){return Xt},this.setScissorTest=function(v){Et.setScissorTest(Xt=v)},this.setOpaqueSort=function(v){et=v},this.setTransparentSort=function(v){rt=v},this.getClearColor=function(v){return v.copy(yt.getClearColor())},this.setClearColor=function(){yt.setClearColor.apply(yt,arguments)},this.getClearAlpha=function(){return yt.getClearAlpha()},this.setClearAlpha=function(){yt.setClearAlpha.apply(yt,arguments)},this.clear=function(v=!0,L=!0,B=!0){let z=0;if(v){let D=!1;if(C!==null){const Q=C.texture.format;D=Q===ca||Q===oa||Q===aa}if(D){const Q=C.texture.type,ct=Q===mn||Q===Xn||Q===Fi||Q===Mi||Q===ra||Q===sa,pt=yt.getClearColor(),mt=yt.getClearAlpha(),bt=pt.r,Ct=pt.g,_t=pt.b;ct?(g[0]=bt,g[1]=Ct,g[2]=_t,g[3]=mt,U.clearBufferuiv(U.COLOR,0,g)):(M[0]=bt,M[1]=Ct,M[2]=_t,M[3]=mt,U.clearBufferiv(U.COLOR,0,M))}else z|=U.COLOR_BUFFER_BIT}L&&(z|=U.DEPTH_BUFFER_BIT),B&&(z|=U.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),U.clear(z)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",$,!1),e.removeEventListener("webglcontextrestored",lt,!1),e.removeEventListener("webglcontextcreationerror",ot,!1),ut.dispose(),Gt.dispose(),St.dispose(),_.dispose(),F.dispose(),Y.dispose(),Jt.dispose(),P.dispose(),vt.dispose(),k.dispose(),k.removeEventListener("sessionstart",_a),k.removeEventListener("sessionend",ga),Ln.stop()};function $(v){v.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),I=!0}function lt(){console.log("THREE.WebGLRenderer: Context Restored."),I=!1;const v=te.autoReset,L=ht.enabled,B=ht.autoUpdate,z=ht.needsUpdate,D=ht.type;it(),te.autoReset=v,ht.enabled=L,ht.autoUpdate=B,ht.needsUpdate=z,ht.type=D}function ot(v){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",v.statusMessage)}function Rt(v){const L=v.target;L.removeEventListener("dispose",Rt),se(L)}function se(v){me(v),St.remove(v)}function me(v){const L=St.get(v).programs;L!==void 0&&(L.forEach(function(B){vt.releaseProgram(B)}),v.isShaderMaterial&&vt.releaseShaderCache(v))}this.renderBufferDirect=function(v,L,B,z,D,Q){L===null&&(L=re);const ct=D.isMesh&&D.matrixWorld.determinant()<0,pt=vc(v,L,B,z,D);Et.setMaterial(z,ct);let mt=B.index,bt=1;if(z.wireframe===!0){if(mt=j.getWireframeAttribute(B),mt===void 0)return;bt=2}const Ct=B.drawRange,_t=B.attributes.position;let kt=Ct.start*bt,Qt=(Ct.start+Ct.count)*bt;Q!==null&&(kt=Math.max(kt,Q.start*bt),Qt=Math.min(Qt,(Q.start+Q.count)*bt)),mt!==null?(kt=Math.max(kt,0),Qt=Math.min(Qt,mt.count)):_t!=null&&(kt=Math.max(kt,0),Qt=Math.min(Qt,_t.count));const ee=Qt-kt;if(ee<0||ee===1/0)return;Jt.setup(D,z,pt,B,mt);let Se,qt=dt;if(mt!==null&&(Se=K.get(mt),qt=zt,qt.setIndex(Se)),D.isMesh)z.wireframe===!0?(Et.setLineWidth(z.wireframeLinewidth*ae()),qt.setMode(U.LINES)):qt.setMode(U.TRIANGLES);else if(D.isLine){let xt=z.linewidth;xt===void 0&&(xt=1),Et.setLineWidth(xt*ae()),D.isLineSegments?qt.setMode(U.LINES):D.isLineLoop?qt.setMode(U.LINE_LOOP):qt.setMode(U.LINE_STRIP)}else D.isPoints?qt.setMode(U.POINTS):D.isSprite&&qt.setMode(U.TRIANGLES);if(D.isBatchedMesh)if(D._multiDrawInstances!==null)qt.renderMultiDrawInstances(D._multiDrawStarts,D._multiDrawCounts,D._multiDrawCount,D._multiDrawInstances);else if(Ot.get("WEBGL_multi_draw"))qt.renderMultiDraw(D._multiDrawStarts,D._multiDrawCounts,D._multiDrawCount);else{const xt=D._multiDrawStarts,en=D._multiDrawCounts,Yt=D._multiDrawCount,ze=mt?K.get(mt).bytesPerElement:1,Zn=St.get(z).currentProgram.getUniforms();for(let we=0;we<Yt;we++)Zn.setValue(U,"_gl_DrawID",we),qt.render(xt[we]/ze,en[we])}else if(D.isInstancedMesh)qt.renderInstances(kt,ee,D.count);else if(B.isInstancedBufferGeometry){const xt=B._maxInstanceCount!==void 0?B._maxInstanceCount:1/0,en=Math.min(B.instanceCount,xt);qt.renderInstances(kt,ee,en)}else qt.render(kt,ee)};function Zt(v,L,B){v.transparent===!0&&v.side===ln&&v.forceSinglePass===!1?(v.side=be,v.needsUpdate=!0,Xi(v,L,B),v.side=Cn,v.needsUpdate=!0,Xi(v,L,B),v.side=ln):Xi(v,L,B)}this.compile=function(v,L,B=null){B===null&&(B=v),l=Gt.get(B),l.init(L),T.push(l),B.traverseVisible(function(D){D.isLight&&D.layers.test(L.layers)&&(l.pushLight(D),D.castShadow&&l.pushShadow(D))}),v!==B&&v.traverseVisible(function(D){D.isLight&&D.layers.test(L.layers)&&(l.pushLight(D),D.castShadow&&l.pushShadow(D))}),l.setupLights();const z=new Set;return v.traverse(function(D){if(!(D.isMesh||D.isPoints||D.isLine||D.isSprite))return;const Q=D.material;if(Q)if(Array.isArray(Q))for(let ct=0;ct<Q.length;ct++){const pt=Q[ct];Zt(pt,B,D),z.add(pt)}else Zt(Q,B,D),z.add(Q)}),T.pop(),l=null,z},this.compileAsync=function(v,L,B=null){const z=this.compile(v,L,B);return new Promise(D=>{function Q(){if(z.forEach(function(ct){St.get(ct).currentProgram.isReady()&&z.delete(ct)}),z.size===0){D(v);return}setTimeout(Q,10)}Ot.get("KHR_parallel_shader_compile")!==null?Q():setTimeout(Q,10)})};let Be=null;function tn(v){Be&&Be(v)}function _a(){Ln.stop()}function ga(){Ln.start()}const Ln=new ac;Ln.setAnimationLoop(tn),typeof self<"u"&&Ln.setContext(self),this.setAnimationLoop=function(v){Be=v,k.setAnimationLoop(v),v===null?Ln.stop():Ln.start()},k.addEventListener("sessionstart",_a),k.addEventListener("sessionend",ga),this.render=function(v,L){if(L!==void 0&&L.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(I===!0)return;if(v.matrixWorldAutoUpdate===!0&&v.updateMatrixWorld(),L.parent===null&&L.matrixWorldAutoUpdate===!0&&L.updateMatrixWorld(),k.enabled===!0&&k.isPresenting===!0&&(k.cameraAutoUpdate===!0&&k.updateCamera(L),L=k.getCamera()),v.isScene===!0&&v.onBeforeRender(E,v,L,C),l=Gt.get(v,T.length),l.init(L),T.push(l),Tt.multiplyMatrices(L.projectionMatrix,L.matrixWorldInverse),Z.setFromProjectionMatrix(Tt),gt=this.localClippingEnabled,tt=J.init(this.clippingPlanes,gt),p=ut.get(v,A.length),p.init(),A.push(p),k.enabled===!0&&k.isPresenting===!0){const Q=E.xr.getDepthSensingMesh();Q!==null&&Ir(Q,L,-1/0,E.sortObjects)}Ir(v,L,0,E.sortObjects),p.finish(),E.sortObjects===!0&&p.sort(et,rt),Ht=k.enabled===!1||k.isPresenting===!1||k.hasDepthSensing()===!1,Ht&&yt.addToRenderList(p,v),this.info.render.frame++,tt===!0&&J.beginShadows();const B=l.state.shadowsArray;ht.render(B,v,L),tt===!0&&J.endShadows(),this.info.autoReset===!0&&this.info.reset();const z=p.opaque,D=p.transmissive;if(l.setupLights(),L.isArrayCamera){const Q=L.cameras;if(D.length>0)for(let ct=0,pt=Q.length;ct<pt;ct++){const mt=Q[ct];xa(z,D,v,mt)}Ht&&yt.render(v);for(let ct=0,pt=Q.length;ct<pt;ct++){const mt=Q[ct];va(p,v,mt,mt.viewport)}}else D.length>0&&xa(z,D,v,L),Ht&&yt.render(v),va(p,v,L);C!==null&&(y.updateMultisampleRenderTarget(C),y.updateRenderTargetMipmap(C)),v.isScene===!0&&v.onAfterRender(E,v,L),Jt.resetDefaultState(),S=-1,x=null,T.pop(),T.length>0?(l=T[T.length-1],tt===!0&&J.setGlobalState(E.clippingPlanes,l.state.camera)):l=null,A.pop(),A.length>0?p=A[A.length-1]:p=null};function Ir(v,L,B,z){if(v.visible===!1)return;if(v.layers.test(L.layers)){if(v.isGroup)B=v.renderOrder;else if(v.isLOD)v.autoUpdate===!0&&v.update(L);else if(v.isLight)l.pushLight(v),v.castShadow&&l.pushShadow(v);else if(v.isSprite){if(!v.frustumCulled||Z.intersectsSprite(v)){z&&Nt.setFromMatrixPosition(v.matrixWorld).applyMatrix4(Tt);const ct=Y.update(v),pt=v.material;pt.visible&&p.push(v,ct,pt,B,Nt.z,null)}}else if((v.isMesh||v.isLine||v.isPoints)&&(!v.frustumCulled||Z.intersectsObject(v))){const ct=Y.update(v),pt=v.material;if(z&&(v.boundingSphere!==void 0?(v.boundingSphere===null&&v.computeBoundingSphere(),Nt.copy(v.boundingSphere.center)):(ct.boundingSphere===null&&ct.computeBoundingSphere(),Nt.copy(ct.boundingSphere.center)),Nt.applyMatrix4(v.matrixWorld).applyMatrix4(Tt)),Array.isArray(pt)){const mt=ct.groups;for(let bt=0,Ct=mt.length;bt<Ct;bt++){const _t=mt[bt],kt=pt[_t.materialIndex];kt&&kt.visible&&p.push(v,ct,kt,B,Nt.z,_t)}}else pt.visible&&p.push(v,ct,pt,B,Nt.z,null)}}const Q=v.children;for(let ct=0,pt=Q.length;ct<pt;ct++)Ir(Q[ct],L,B,z)}function va(v,L,B,z){const D=v.opaque,Q=v.transmissive,ct=v.transparent;l.setupLightsView(B),tt===!0&&J.setGlobalState(E.clippingPlanes,B),z&&Et.viewport(R.copy(z)),D.length>0&&Wi(D,L,B),Q.length>0&&Wi(Q,L,B),ct.length>0&&Wi(ct,L,B),Et.buffers.depth.setTest(!0),Et.buffers.depth.setMask(!0),Et.buffers.color.setMask(!0),Et.setPolygonOffset(!1)}function xa(v,L,B,z){if((B.isScene===!0?B.overrideMaterial:null)!==null)return;l.state.transmissionRenderTarget[z.id]===void 0&&(l.state.transmissionRenderTarget[z.id]=new qn(1,1,{generateMipmaps:!0,type:Ot.has("EXT_color_buffer_half_float")||Ot.has("EXT_color_buffer_float")?Bi:mn,minFilter:kn,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Vt.workingColorSpace}));const Q=l.state.transmissionRenderTarget[z.id],ct=z.viewport||R;Q.setSize(ct.z,ct.w);const pt=E.getRenderTarget();E.setRenderTarget(Q),E.getClearColor(W),q=E.getClearAlpha(),q<1&&E.setClearColor(16777215,.5),E.clear(),Ht&&yt.render(B);const mt=E.toneMapping;E.toneMapping=Rn;const bt=z.viewport;if(z.viewport!==void 0&&(z.viewport=void 0),l.setupLightsView(z),tt===!0&&J.setGlobalState(E.clippingPlanes,z),Wi(v,B,z),y.updateMultisampleRenderTarget(Q),y.updateRenderTargetMipmap(Q),Ot.has("WEBGL_multisampled_render_to_texture")===!1){let Ct=!1;for(let _t=0,kt=L.length;_t<kt;_t++){const Qt=L[_t],ee=Qt.object,Se=Qt.geometry,qt=Qt.material,xt=Qt.group;if(qt.side===ln&&ee.layers.test(z.layers)){const en=qt.side;qt.side=be,qt.needsUpdate=!0,Ma(ee,B,z,Se,qt,xt),qt.side=en,qt.needsUpdate=!0,Ct=!0}}Ct===!0&&(y.updateMultisampleRenderTarget(Q),y.updateRenderTargetMipmap(Q))}E.setRenderTarget(pt),E.setClearColor(W,q),bt!==void 0&&(z.viewport=bt),E.toneMapping=mt}function Wi(v,L,B){const z=L.isScene===!0?L.overrideMaterial:null;for(let D=0,Q=v.length;D<Q;D++){const ct=v[D],pt=ct.object,mt=ct.geometry,bt=z===null?ct.material:z,Ct=ct.group;pt.layers.test(B.layers)&&Ma(pt,L,B,mt,bt,Ct)}}function Ma(v,L,B,z,D,Q){v.onBeforeRender(E,L,B,z,D,Q),v.modelViewMatrix.multiplyMatrices(B.matrixWorldInverse,v.matrixWorld),v.normalMatrix.getNormalMatrix(v.modelViewMatrix),D.onBeforeRender(E,L,B,z,v,Q),D.transparent===!0&&D.side===ln&&D.forceSinglePass===!1?(D.side=be,D.needsUpdate=!0,E.renderBufferDirect(B,L,z,D,v,Q),D.side=Cn,D.needsUpdate=!0,E.renderBufferDirect(B,L,z,D,v,Q),D.side=ln):E.renderBufferDirect(B,L,z,D,v,Q),v.onAfterRender(E,L,B,z,D,Q)}function Xi(v,L,B){L.isScene!==!0&&(L=re);const z=St.get(v),D=l.state.lights,Q=l.state.shadowsArray,ct=D.state.version,pt=vt.getParameters(v,D.state,Q,L,B),mt=vt.getProgramCacheKey(pt);let bt=z.programs;z.environment=v.isMeshStandardMaterial?L.environment:null,z.fog=L.fog,z.envMap=(v.isMeshStandardMaterial?F:_).get(v.envMap||z.environment),z.envMapRotation=z.environment!==null&&v.envMap===null?L.environmentRotation:v.envMapRotation,bt===void 0&&(v.addEventListener("dispose",Rt),bt=new Map,z.programs=bt);let Ct=bt.get(mt);if(Ct!==void 0){if(z.currentProgram===Ct&&z.lightsStateVersion===ct)return Ea(v,pt),Ct}else pt.uniforms=vt.getUniforms(v),v.onBeforeCompile(pt,E),Ct=vt.acquireProgram(pt,mt),bt.set(mt,Ct),z.uniforms=pt.uniforms;const _t=z.uniforms;return(!v.isShaderMaterial&&!v.isRawShaderMaterial||v.clipping===!0)&&(_t.clippingPlanes=J.uniform),Ea(v,pt),z.needsLights=Mc(v),z.lightsStateVersion=ct,z.needsLights&&(_t.ambientLightColor.value=D.state.ambient,_t.lightProbe.value=D.state.probe,_t.directionalLights.value=D.state.directional,_t.directionalLightShadows.value=D.state.directionalShadow,_t.spotLights.value=D.state.spot,_t.spotLightShadows.value=D.state.spotShadow,_t.rectAreaLights.value=D.state.rectArea,_t.ltc_1.value=D.state.rectAreaLTC1,_t.ltc_2.value=D.state.rectAreaLTC2,_t.pointLights.value=D.state.point,_t.pointLightShadows.value=D.state.pointShadow,_t.hemisphereLights.value=D.state.hemi,_t.directionalShadowMap.value=D.state.directionalShadowMap,_t.directionalShadowMatrix.value=D.state.directionalShadowMatrix,_t.spotShadowMap.value=D.state.spotShadowMap,_t.spotLightMatrix.value=D.state.spotLightMatrix,_t.spotLightMap.value=D.state.spotLightMap,_t.pointShadowMap.value=D.state.pointShadowMap,_t.pointShadowMatrix.value=D.state.pointShadowMatrix),z.currentProgram=Ct,z.uniformsList=null,Ct}function Sa(v){if(v.uniformsList===null){const L=v.currentProgram.getUniforms();v.uniformsList=Mr.seqWithValue(L.seq,v.uniforms)}return v.uniformsList}function Ea(v,L){const B=St.get(v);B.outputColorSpace=L.outputColorSpace,B.batching=L.batching,B.batchingColor=L.batchingColor,B.instancing=L.instancing,B.instancingColor=L.instancingColor,B.instancingMorph=L.instancingMorph,B.skinning=L.skinning,B.morphTargets=L.morphTargets,B.morphNormals=L.morphNormals,B.morphColors=L.morphColors,B.morphTargetsCount=L.morphTargetsCount,B.numClippingPlanes=L.numClippingPlanes,B.numIntersection=L.numClipIntersection,B.vertexAlphas=L.vertexAlphas,B.vertexTangents=L.vertexTangents,B.toneMapping=L.toneMapping}function vc(v,L,B,z,D){L.isScene!==!0&&(L=re),y.resetTextureUnits();const Q=L.fog,ct=z.isMeshStandardMaterial?L.environment:null,pt=C===null?E.outputColorSpace:C.isXRRenderTarget===!0?C.texture.colorSpace:yi,mt=(z.isMeshStandardMaterial?F:_).get(z.envMap||ct),bt=z.vertexColors===!0&&!!B.attributes.color&&B.attributes.color.itemSize===4,Ct=!!B.attributes.tangent&&(!!z.normalMap||z.anisotropy>0),_t=!!B.morphAttributes.position,kt=!!B.morphAttributes.normal,Qt=!!B.morphAttributes.color;let ee=Rn;z.toneMapped&&(C===null||C.isXRRenderTarget===!0)&&(ee=E.toneMapping);const Se=B.morphAttributes.position||B.morphAttributes.normal||B.morphAttributes.color,qt=Se!==void 0?Se.length:0,xt=St.get(z),en=l.state.lights;if(tt===!0&&(gt===!0||v!==x)){const De=v===x&&z.id===S;J.setState(z,v,De)}let Yt=!1;z.version===xt.__version?(xt.needsLights&&xt.lightsStateVersion!==en.state.version||xt.outputColorSpace!==pt||D.isBatchedMesh&&xt.batching===!1||!D.isBatchedMesh&&xt.batching===!0||D.isBatchedMesh&&xt.batchingColor===!0&&D.colorTexture===null||D.isBatchedMesh&&xt.batchingColor===!1&&D.colorTexture!==null||D.isInstancedMesh&&xt.instancing===!1||!D.isInstancedMesh&&xt.instancing===!0||D.isSkinnedMesh&&xt.skinning===!1||!D.isSkinnedMesh&&xt.skinning===!0||D.isInstancedMesh&&xt.instancingColor===!0&&D.instanceColor===null||D.isInstancedMesh&&xt.instancingColor===!1&&D.instanceColor!==null||D.isInstancedMesh&&xt.instancingMorph===!0&&D.morphTexture===null||D.isInstancedMesh&&xt.instancingMorph===!1&&D.morphTexture!==null||xt.envMap!==mt||z.fog===!0&&xt.fog!==Q||xt.numClippingPlanes!==void 0&&(xt.numClippingPlanes!==J.numPlanes||xt.numIntersection!==J.numIntersection)||xt.vertexAlphas!==bt||xt.vertexTangents!==Ct||xt.morphTargets!==_t||xt.morphNormals!==kt||xt.morphColors!==Qt||xt.toneMapping!==ee||xt.morphTargetsCount!==qt)&&(Yt=!0):(Yt=!0,xt.__version=z.version);let ze=xt.currentProgram;Yt===!0&&(ze=Xi(z,L,D));let Zn=!1,we=!1,Ai=!1;const ne=ze.getUniforms(),Ye=xt.uniforms;if(Et.useProgram(ze.program)&&(Zn=!0,we=!0,Ai=!0),z.id!==S&&(S=z.id,we=!0),Zn||x!==v){Et.buffers.depth.getReversed()?(st.copy(v.projectionMatrix),ll(st),ul(st),ne.setValue(U,"projectionMatrix",st)):ne.setValue(U,"projectionMatrix",v.projectionMatrix),ne.setValue(U,"viewMatrix",v.matrixWorldInverse);const gn=ne.map.cameraPosition;gn!==void 0&&gn.setValue(U,wt.setFromMatrixPosition(v.matrixWorld)),Bt.logarithmicDepthBuffer&&ne.setValue(U,"logDepthBufFC",2/(Math.log(v.far+1)/Math.LN2)),(z.isMeshPhongMaterial||z.isMeshToonMaterial||z.isMeshLambertMaterial||z.isMeshBasicMaterial||z.isMeshStandardMaterial||z.isShaderMaterial)&&ne.setValue(U,"isOrthographic",v.isOrthographicCamera===!0),x!==v&&(x=v,we=!0,Ai=!0)}if(D.isSkinnedMesh){ne.setOptional(U,D,"bindMatrix"),ne.setOptional(U,D,"bindMatrixInverse");const De=D.skeleton;De&&(De.boneTexture===null&&De.computeBoneTexture(),ne.setValue(U,"boneTexture",De.boneTexture,y))}D.isBatchedMesh&&(ne.setOptional(U,D,"batchingTexture"),ne.setValue(U,"batchingTexture",D._matricesTexture,y),ne.setOptional(U,D,"batchingIdTexture"),ne.setValue(U,"batchingIdTexture",D._indirectTexture,y),ne.setOptional(U,D,"batchingColorTexture"),D._colorsTexture!==null&&ne.setValue(U,"batchingColorTexture",D._colorsTexture,y));const bi=B.morphAttributes;if((bi.position!==void 0||bi.normal!==void 0||bi.color!==void 0)&&At.update(D,B,ze),(we||xt.receiveShadow!==D.receiveShadow)&&(xt.receiveShadow=D.receiveShadow,ne.setValue(U,"receiveShadow",D.receiveShadow)),z.isMeshGouraudMaterial&&z.envMap!==null&&(Ye.envMap.value=mt,Ye.flipEnvMap.value=mt.isCubeTexture&&mt.isRenderTargetTexture===!1?-1:1),z.isMeshStandardMaterial&&z.envMap===null&&L.environment!==null&&(Ye.envMapIntensity.value=L.environmentIntensity),we&&(ne.setValue(U,"toneMappingExposure",E.toneMappingExposure),xt.needsLights&&xc(Ye,Ai),Q&&z.fog===!0&&at.refreshFogUniforms(Ye,Q),at.refreshMaterialUniforms(Ye,z,H,X,l.state.transmissionRenderTarget[v.id]),Mr.upload(U,Sa(xt),Ye,y)),z.isShaderMaterial&&z.uniformsNeedUpdate===!0&&(Mr.upload(U,Sa(xt),Ye,y),z.uniformsNeedUpdate=!1),z.isSpriteMaterial&&ne.setValue(U,"center",D.center),ne.setValue(U,"modelViewMatrix",D.modelViewMatrix),ne.setValue(U,"normalMatrix",D.normalMatrix),ne.setValue(U,"modelMatrix",D.matrixWorld),z.isShaderMaterial||z.isRawShaderMaterial){const De=z.uniformsGroups;for(let gn=0,vn=De.length;gn<vn;gn++){const ya=De[gn];P.update(ya,ze),P.bind(ya,ze)}}return ze}function xc(v,L){v.ambientLightColor.needsUpdate=L,v.lightProbe.needsUpdate=L,v.directionalLights.needsUpdate=L,v.directionalLightShadows.needsUpdate=L,v.pointLights.needsUpdate=L,v.pointLightShadows.needsUpdate=L,v.spotLights.needsUpdate=L,v.spotLightShadows.needsUpdate=L,v.rectAreaLights.needsUpdate=L,v.hemisphereLights.needsUpdate=L}function Mc(v){return v.isMeshLambertMaterial||v.isMeshToonMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isShadowMaterial||v.isShaderMaterial&&v.lights===!0}this.getActiveCubeFace=function(){return b},this.getActiveMipmapLevel=function(){return w},this.getRenderTarget=function(){return C},this.setRenderTargetTextures=function(v,L,B){St.get(v.texture).__webglTexture=L,St.get(v.depthTexture).__webglTexture=B;const z=St.get(v);z.__hasExternalTextures=!0,z.__autoAllocateDepthBuffer=B===void 0,z.__autoAllocateDepthBuffer||Ot.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),z.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(v,L){const B=St.get(v);B.__webglFramebuffer=L,B.__useDefaultFramebuffer=L===void 0},this.setRenderTarget=function(v,L=0,B=0){C=v,b=L,w=B;let z=!0,D=null,Q=!1,ct=!1;if(v){const mt=St.get(v);if(mt.__useDefaultFramebuffer!==void 0)Et.bindFramebuffer(U.FRAMEBUFFER,null),z=!1;else if(mt.__webglFramebuffer===void 0)y.setupRenderTarget(v);else if(mt.__hasExternalTextures)y.rebindTextures(v,St.get(v.texture).__webglTexture,St.get(v.depthTexture).__webglTexture);else if(v.depthBuffer){const _t=v.depthTexture;if(mt.__boundDepthTexture!==_t){if(_t!==null&&St.has(_t)&&(v.width!==_t.image.width||v.height!==_t.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");y.setupDepthRenderbuffer(v)}}const bt=v.texture;(bt.isData3DTexture||bt.isDataArrayTexture||bt.isCompressedArrayTexture)&&(ct=!0);const Ct=St.get(v).__webglFramebuffer;v.isWebGLCubeRenderTarget?(Array.isArray(Ct[L])?D=Ct[L][B]:D=Ct[L],Q=!0):v.samples>0&&y.useMultisampledRTT(v)===!1?D=St.get(v).__webglMultisampledFramebuffer:Array.isArray(Ct)?D=Ct[B]:D=Ct,R.copy(v.viewport),G.copy(v.scissor),O=v.scissorTest}else R.copy(ft).multiplyScalar(H).floor(),G.copy(It).multiplyScalar(H).floor(),O=Xt;if(Et.bindFramebuffer(U.FRAMEBUFFER,D)&&z&&Et.drawBuffers(v,D),Et.viewport(R),Et.scissor(G),Et.setScissorTest(O),Q){const mt=St.get(v.texture);U.framebufferTexture2D(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_CUBE_MAP_POSITIVE_X+L,mt.__webglTexture,B)}else if(ct){const mt=St.get(v.texture),bt=L||0;U.framebufferTextureLayer(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,mt.__webglTexture,B||0,bt)}S=-1},this.readRenderTargetPixels=function(v,L,B,z,D,Q,ct){if(!(v&&v.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let pt=St.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&ct!==void 0&&(pt=pt[ct]),pt){Et.bindFramebuffer(U.FRAMEBUFFER,pt);try{const mt=v.texture,bt=mt.format,Ct=mt.type;if(!Bt.textureFormatReadable(bt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Bt.textureTypeReadable(Ct)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}L>=0&&L<=v.width-z&&B>=0&&B<=v.height-D&&U.readPixels(L,B,z,D,Lt.convert(bt),Lt.convert(Ct),Q)}finally{const mt=C!==null?St.get(C).__webglFramebuffer:null;Et.bindFramebuffer(U.FRAMEBUFFER,mt)}}},this.readRenderTargetPixelsAsync=async function(v,L,B,z,D,Q,ct){if(!(v&&v.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let pt=St.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&ct!==void 0&&(pt=pt[ct]),pt){const mt=v.texture,bt=mt.format,Ct=mt.type;if(!Bt.textureFormatReadable(bt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Bt.textureTypeReadable(Ct))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(L>=0&&L<=v.width-z&&B>=0&&B<=v.height-D){Et.bindFramebuffer(U.FRAMEBUFFER,pt);const _t=U.createBuffer();U.bindBuffer(U.PIXEL_PACK_BUFFER,_t),U.bufferData(U.PIXEL_PACK_BUFFER,Q.byteLength,U.STREAM_READ),U.readPixels(L,B,z,D,Lt.convert(bt),Lt.convert(Ct),0);const kt=C!==null?St.get(C).__webglFramebuffer:null;Et.bindFramebuffer(U.FRAMEBUFFER,kt);const Qt=U.fenceSync(U.SYNC_GPU_COMMANDS_COMPLETE,0);return U.flush(),await cl(U,Qt,4),U.bindBuffer(U.PIXEL_PACK_BUFFER,_t),U.getBufferSubData(U.PIXEL_PACK_BUFFER,0,Q),U.deleteBuffer(_t),U.deleteSync(Qt),Q}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(v,L=null,B=0){v.isTexture!==!0&&(Ui("WebGLRenderer: copyFramebufferToTexture function signature has changed."),L=arguments[0]||null,v=arguments[1]);const z=Math.pow(2,-B),D=Math.floor(v.image.width*z),Q=Math.floor(v.image.height*z),ct=L!==null?L.x:0,pt=L!==null?L.y:0;y.setTexture2D(v,0),U.copyTexSubImage2D(U.TEXTURE_2D,B,0,0,ct,pt,D,Q),Et.unbindTexture()},this.copyTextureToTexture=function(v,L,B=null,z=null,D=0){v.isTexture!==!0&&(Ui("WebGLRenderer: copyTextureToTexture function signature has changed."),z=arguments[0]||null,v=arguments[1],L=arguments[2],D=arguments[3]||0,B=null);let Q,ct,pt,mt,bt,Ct,_t,kt,Qt;const ee=v.isCompressedTexture?v.mipmaps[D]:v.image;B!==null?(Q=B.max.x-B.min.x,ct=B.max.y-B.min.y,pt=B.isBox3?B.max.z-B.min.z:1,mt=B.min.x,bt=B.min.y,Ct=B.isBox3?B.min.z:0):(Q=ee.width,ct=ee.height,pt=ee.depth||1,mt=0,bt=0,Ct=0),z!==null?(_t=z.x,kt=z.y,Qt=z.z):(_t=0,kt=0,Qt=0);const Se=Lt.convert(L.format),qt=Lt.convert(L.type);let xt;L.isData3DTexture?(y.setTexture3D(L,0),xt=U.TEXTURE_3D):L.isDataArrayTexture||L.isCompressedArrayTexture?(y.setTexture2DArray(L,0),xt=U.TEXTURE_2D_ARRAY):(y.setTexture2D(L,0),xt=U.TEXTURE_2D),U.pixelStorei(U.UNPACK_FLIP_Y_WEBGL,L.flipY),U.pixelStorei(U.UNPACK_PREMULTIPLY_ALPHA_WEBGL,L.premultiplyAlpha),U.pixelStorei(U.UNPACK_ALIGNMENT,L.unpackAlignment);const en=U.getParameter(U.UNPACK_ROW_LENGTH),Yt=U.getParameter(U.UNPACK_IMAGE_HEIGHT),ze=U.getParameter(U.UNPACK_SKIP_PIXELS),Zn=U.getParameter(U.UNPACK_SKIP_ROWS),we=U.getParameter(U.UNPACK_SKIP_IMAGES);U.pixelStorei(U.UNPACK_ROW_LENGTH,ee.width),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,ee.height),U.pixelStorei(U.UNPACK_SKIP_PIXELS,mt),U.pixelStorei(U.UNPACK_SKIP_ROWS,bt),U.pixelStorei(U.UNPACK_SKIP_IMAGES,Ct);const Ai=v.isDataArrayTexture||v.isData3DTexture,ne=L.isDataArrayTexture||L.isData3DTexture;if(v.isRenderTargetTexture||v.isDepthTexture){const Ye=St.get(v),bi=St.get(L),De=St.get(Ye.__renderTarget),gn=St.get(bi.__renderTarget);Et.bindFramebuffer(U.READ_FRAMEBUFFER,De.__webglFramebuffer),Et.bindFramebuffer(U.DRAW_FRAMEBUFFER,gn.__webglFramebuffer);for(let vn=0;vn<pt;vn++)Ai&&U.framebufferTextureLayer(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,St.get(v).__webglTexture,D,Ct+vn),v.isDepthTexture?(ne&&U.framebufferTextureLayer(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,St.get(L).__webglTexture,D,Qt+vn),U.blitFramebuffer(mt,bt,Q,ct,_t,kt,Q,ct,U.DEPTH_BUFFER_BIT,U.NEAREST)):ne?U.copyTexSubImage3D(xt,D,_t,kt,Qt+vn,mt,bt,Q,ct):U.copyTexSubImage2D(xt,D,_t,kt,Qt+vn,mt,bt,Q,ct);Et.bindFramebuffer(U.READ_FRAMEBUFFER,null),Et.bindFramebuffer(U.DRAW_FRAMEBUFFER,null)}else ne?v.isDataTexture||v.isData3DTexture?U.texSubImage3D(xt,D,_t,kt,Qt,Q,ct,pt,Se,qt,ee.data):L.isCompressedArrayTexture?U.compressedTexSubImage3D(xt,D,_t,kt,Qt,Q,ct,pt,Se,ee.data):U.texSubImage3D(xt,D,_t,kt,Qt,Q,ct,pt,Se,qt,ee):v.isDataTexture?U.texSubImage2D(U.TEXTURE_2D,D,_t,kt,Q,ct,Se,qt,ee.data):v.isCompressedTexture?U.compressedTexSubImage2D(U.TEXTURE_2D,D,_t,kt,ee.width,ee.height,Se,ee.data):U.texSubImage2D(U.TEXTURE_2D,D,_t,kt,Q,ct,Se,qt,ee);U.pixelStorei(U.UNPACK_ROW_LENGTH,en),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,Yt),U.pixelStorei(U.UNPACK_SKIP_PIXELS,ze),U.pixelStorei(U.UNPACK_SKIP_ROWS,Zn),U.pixelStorei(U.UNPACK_SKIP_IMAGES,we),D===0&&L.generateMipmaps&&U.generateMipmap(xt),Et.unbindTexture()},this.copyTextureToTexture3D=function(v,L,B=null,z=null,D=0){return v.isTexture!==!0&&(Ui("WebGLRenderer: copyTextureToTexture3D function signature has changed."),B=arguments[0]||null,z=arguments[1]||null,v=arguments[2],L=arguments[3],D=arguments[4]||0),Ui('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(v,L,B,z,D)},this.initRenderTarget=function(v){St.get(v).__webglFramebuffer===void 0&&y.setupRenderTarget(v)},this.initTexture=function(v){v.isCubeTexture?y.setTextureCube(v,0):v.isData3DTexture?y.setTexture3D(v,0):v.isDataArrayTexture||v.isCompressedArrayTexture?y.setTexture2DArray(v,0):y.setTexture2D(v,0),Et.unbindTexture()},this.resetState=function(){b=0,w=0,C=null,Et.reset(),Jt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return dn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorspace=Vt._getDrawingBufferColorSpace(t),e.unpackColorSpace=Vt._getUnpackColorSpace()}}class ki{constructor(t,e=25e-5){this.isFogExp2=!0,this.name="",this.color=new Ft(t),this.density=e}clone(){return new ki(this.color,this.density)}toJSON(){return{type:"FogExp2",name:this.name,color:this.color.getHex(),density:this.density}}}class Ep extends ve{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new qe,this.environmentIntensity=1,this.environmentRotation=new qe,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(t,e){return super.copy(t,e),t.background!==null&&(this.background=t.background.clone()),t.environment!==null&&(this.environment=t.environment.clone()),t.fog!==null&&(this.fog=t.fog.clone()),this.backgroundBlurriness=t.backgroundBlurriness,this.backgroundIntensity=t.backgroundIntensity,this.backgroundRotation.copy(t.backgroundRotation),this.environmentIntensity=t.environmentIntensity,this.environmentRotation.copy(t.environmentRotation),t.overrideMaterial!==null&&(this.overrideMaterial=t.overrideMaterial.clone()),this.matrixAutoUpdate=t.matrixAutoUpdate,this}toJSON(t){const e=super.toJSON(t);return this.fog!==null&&(e.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(e.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(e.object.backgroundIntensity=this.backgroundIntensity),e.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(e.object.environmentIntensity=this.environmentIntensity),e.object.environmentRotation=this.environmentRotation.toArray(),e}}class dc extends Me{constructor(t,e,n,r,s,a,o,c,u){super(t,e,n,r,s,a,o,c,u),this.isCanvasTexture=!0,this.needsUpdate=!0}}class Ne extends _n{constructor(t=1,e=1,n=1,r=32,s=1,a=!1,o=0,c=Math.PI*2){super(),this.type="CylinderGeometry",this.parameters={radiusTop:t,radiusBottom:e,height:n,radialSegments:r,heightSegments:s,openEnded:a,thetaStart:o,thetaLength:c};const u=this;r=Math.floor(r),s=Math.floor(s);const h=[],d=[],f=[],m=[];let g=0;const M=[],p=n/2;let l=0;A(),a===!1&&(t>0&&T(!0),e>0&&T(!1)),this.setIndex(h),this.setAttribute("position",new Pe(d,3)),this.setAttribute("normal",new Pe(f,3)),this.setAttribute("uv",new Pe(m,2));function A(){const E=new N,I=new N;let b=0;const w=(e-t)/n;for(let C=0;C<=s;C++){const S=[],x=C/s,R=x*(e-t)+t;for(let G=0;G<=r;G++){const O=G/r,W=O*c+o,q=Math.sin(W),V=Math.cos(W);I.x=R*q,I.y=-x*n+p,I.z=R*V,d.push(I.x,I.y,I.z),E.set(q,w,V).normalize(),f.push(E.x,E.y,E.z),m.push(O,1-x),S.push(g++)}M.push(S)}for(let C=0;C<r;C++)for(let S=0;S<s;S++){const x=M[S][C],R=M[S+1][C],G=M[S+1][C+1],O=M[S][C+1];(t>0||S!==0)&&(h.push(x,R,O),b+=3),(e>0||S!==s-1)&&(h.push(R,G,O),b+=3)}u.addGroup(l,b,0),l+=b}function T(E){const I=g,b=new Wt,w=new N;let C=0;const S=E===!0?t:e,x=E===!0?1:-1;for(let G=1;G<=r;G++)d.push(0,p*x,0),f.push(0,x,0),m.push(.5,.5),g++;const R=g;for(let G=0;G<=r;G++){const W=G/r*c+o,q=Math.cos(W),V=Math.sin(W);w.x=S*V,w.y=p*x,w.z=S*q,d.push(w.x,w.y,w.z),f.push(0,x,0),b.x=q*.5+.5,b.y=V*.5*x+.5,m.push(b.x,b.y),g++}for(let G=0;G<r;G++){const O=I+G,W=R+G;E===!0?h.push(W,W+1,O):h.push(W+1,W,O),C+=3}u.addGroup(l,C,E===!0?1:2),l+=C}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new Ne(t.radiusTop,t.radiusBottom,t.height,t.radialSegments,t.heightSegments,t.openEnded,t.thetaStart,t.thetaLength)}}class _i extends _n{constructor(t=1,e=32,n=16,r=0,s=Math.PI*2,a=0,o=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:t,widthSegments:e,heightSegments:n,phiStart:r,phiLength:s,thetaStart:a,thetaLength:o},e=Math.max(3,Math.floor(e)),n=Math.max(2,Math.floor(n));const c=Math.min(a+o,Math.PI);let u=0;const h=[],d=new N,f=new N,m=[],g=[],M=[],p=[];for(let l=0;l<=n;l++){const A=[],T=l/n;let E=0;l===0&&a===0?E=.5/e:l===n&&c===Math.PI&&(E=-.5/e);for(let I=0;I<=e;I++){const b=I/e;d.x=-t*Math.cos(r+b*s)*Math.sin(a+T*o),d.y=t*Math.cos(a+T*o),d.z=t*Math.sin(r+b*s)*Math.sin(a+T*o),g.push(d.x,d.y,d.z),f.copy(d).normalize(),M.push(f.x,f.y,f.z),p.push(b+E,1-T),A.push(u++)}h.push(A)}for(let l=0;l<n;l++)for(let A=0;A<e;A++){const T=h[l][A+1],E=h[l][A],I=h[l+1][A],b=h[l+1][A+1];(l!==0||a>0)&&m.push(T,E,b),(l!==n-1||c<Math.PI)&&m.push(E,I,b)}this.setIndex(m),this.setAttribute("position",new Pe(g,3)),this.setAttribute("normal",new Pe(M,3)),this.setAttribute("uv",new Pe(p,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new _i(t.radius,t.widthSegments,t.heightSegments,t.phiStart,t.phiLength,t.thetaStart,t.thetaLength)}}class oe extends Vi{static get type(){return"MeshStandardMaterial"}constructor(t){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.color=new Ft(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Ft(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=Zo,this.normalScale=new Wt(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new qe,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.defines={STANDARD:""},this.color.copy(t.color),this.roughness=t.roughness,this.metalness=t.metalness,this.map=t.map,this.lightMap=t.lightMap,this.lightMapIntensity=t.lightMapIntensity,this.aoMap=t.aoMap,this.aoMapIntensity=t.aoMapIntensity,this.emissive.copy(t.emissive),this.emissiveMap=t.emissiveMap,this.emissiveIntensity=t.emissiveIntensity,this.bumpMap=t.bumpMap,this.bumpScale=t.bumpScale,this.normalMap=t.normalMap,this.normalMapType=t.normalMapType,this.normalScale.copy(t.normalScale),this.displacementMap=t.displacementMap,this.displacementScale=t.displacementScale,this.displacementBias=t.displacementBias,this.roughnessMap=t.roughnessMap,this.metalnessMap=t.metalnessMap,this.alphaMap=t.alphaMap,this.envMap=t.envMap,this.envMapRotation.copy(t.envMapRotation),this.envMapIntensity=t.envMapIntensity,this.wireframe=t.wireframe,this.wireframeLinewidth=t.wireframeLinewidth,this.wireframeLinecap=t.wireframeLinecap,this.wireframeLinejoin=t.wireframeLinejoin,this.flatShading=t.flatShading,this.fog=t.fog,this}}class fa extends ve{constructor(t,e=1){super(),this.isLight=!0,this.type="Light",this.color=new Ft(t),this.intensity=e}dispose(){}copy(t,e){return super.copy(t,e),this.color.copy(t.color),this.intensity=t.intensity,this}toJSON(t){const e=super.toJSON(t);return e.object.color=this.color.getHex(),e.object.intensity=this.intensity,this.groundColor!==void 0&&(e.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(e.object.distance=this.distance),this.angle!==void 0&&(e.object.angle=this.angle),this.decay!==void 0&&(e.object.decay=this.decay),this.penumbra!==void 0&&(e.object.penumbra=this.penumbra),this.shadow!==void 0&&(e.object.shadow=this.shadow.toJSON()),this.target!==void 0&&(e.object.target=this.target.uuid),e}}const hs=new ie,yo=new N,To=new N;class fc{constructor(t){this.camera=t,this.intensity=1,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new Wt(512,512),this.map=null,this.mapPass=null,this.matrix=new ie,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new ha,this._frameExtents=new Wt(1,1),this._viewportCount=1,this._viewports=[new $t(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(t){const e=this.camera,n=this.matrix;yo.setFromMatrixPosition(t.matrixWorld),e.position.copy(yo),To.setFromMatrixPosition(t.target.matrixWorld),e.lookAt(To),e.updateMatrixWorld(),hs.multiplyMatrices(e.projectionMatrix,e.matrixWorldInverse),this._frustum.setFromProjectionMatrix(hs),n.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),n.multiply(hs)}getViewport(t){return this._viewports[t]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(t){return this.camera=t.camera.clone(),this.intensity=t.intensity,this.bias=t.bias,this.radius=t.radius,this.mapSize.copy(t.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const t={};return this.intensity!==1&&(t.intensity=this.intensity),this.bias!==0&&(t.bias=this.bias),this.normalBias!==0&&(t.normalBias=this.normalBias),this.radius!==1&&(t.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(t.mapSize=this.mapSize.toArray()),t.camera=this.camera.toJSON(!1).object,delete t.camera.matrix,t}}class yp extends fc{constructor(){super(new Ae(50,1,.5,500)),this.isSpotLightShadow=!0,this.focus=1}updateMatrices(t){const e=this.camera,n=br*2*t.angle*this.focus,r=this.mapSize.width/this.mapSize.height,s=t.distance||e.far;(n!==e.fov||r!==e.aspect||s!==e.far)&&(e.fov=n,e.aspect=r,e.far=s,e.updateProjectionMatrix()),super.updateMatrices(t)}copy(t){return super.copy(t),this.focus=t.focus,this}}class Tp extends fa{constructor(t,e,n=0,r=Math.PI/3,s=0,a=2){super(t,e),this.isSpotLight=!0,this.type="SpotLight",this.position.copy(ve.DEFAULT_UP),this.updateMatrix(),this.target=new ve,this.distance=n,this.angle=r,this.penumbra=s,this.decay=a,this.map=null,this.shadow=new yp}get power(){return this.intensity*Math.PI}set power(t){this.intensity=t/Math.PI}dispose(){this.shadow.dispose()}copy(t,e){return super.copy(t,e),this.distance=t.distance,this.angle=t.angle,this.penumbra=t.penumbra,this.decay=t.decay,this.target=t.target.clone(),this.shadow=t.shadow.clone(),this}}const Ao=new ie,Di=new N,ds=new N;class Ap extends fc{constructor(){super(new Ae(90,1,.5,500)),this.isPointLightShadow=!0,this._frameExtents=new Wt(4,2),this._viewportCount=6,this._viewports=[new $t(2,1,1,1),new $t(0,1,1,1),new $t(3,1,1,1),new $t(1,1,1,1),new $t(3,0,1,1),new $t(1,0,1,1)],this._cubeDirections=[new N(1,0,0),new N(-1,0,0),new N(0,0,1),new N(0,0,-1),new N(0,1,0),new N(0,-1,0)],this._cubeUps=[new N(0,1,0),new N(0,1,0),new N(0,1,0),new N(0,1,0),new N(0,0,1),new N(0,0,-1)]}updateMatrices(t,e=0){const n=this.camera,r=this.matrix,s=t.distance||n.far;s!==n.far&&(n.far=s,n.updateProjectionMatrix()),Di.setFromMatrixPosition(t.matrixWorld),n.position.copy(Di),ds.copy(n.position),ds.add(this._cubeDirections[e]),n.up.copy(this._cubeUps[e]),n.lookAt(ds),n.updateMatrixWorld(),r.makeTranslation(-Di.x,-Di.y,-Di.z),Ao.multiplyMatrices(n.projectionMatrix,n.matrixWorldInverse),this._frustum.setFromProjectionMatrix(Ao)}}class Sr extends fa{constructor(t,e,n=0,r=2){super(t,e),this.isPointLight=!0,this.type="PointLight",this.distance=n,this.decay=r,this.shadow=new Ap}get power(){return this.intensity*4*Math.PI}set power(t){this.intensity=t/(4*Math.PI)}dispose(){this.shadow.dispose()}copy(t,e){return super.copy(t,e),this.distance=t.distance,this.decay=t.decay,this.shadow=t.shadow.clone(),this}}class pc extends fa{constructor(t,e){super(t,e),this.isAmbientLight=!0,this.type="AmbientLight"}}class bp{constructor(t=!0){this.autoStart=t,this.startTime=0,this.oldTime=0,this.elapsedTime=0,this.running=!1}start(){this.startTime=bo(),this.oldTime=this.startTime,this.elapsedTime=0,this.running=!0}stop(){this.getElapsedTime(),this.running=!1,this.autoStart=!1}getElapsedTime(){return this.getDelta(),this.elapsedTime}getDelta(){let t=0;if(this.autoStart&&!this.running)return this.start(),0;if(this.running){const e=bo();t=(e-this.oldTime)/1e3,this.oldTime=e,this.elapsedTime+=t}return t}}function bo(){return performance.now()}const wo=new ie;class wp{constructor(t,e,n=0,r=1/0){this.ray=new Qo(t,e),this.near=n,this.far=r,this.camera=null,this.layers=new ua,this.params={Mesh:{},Line:{threshold:1},LOD:{},Points:{threshold:1},Sprite:{}}}set(t,e){this.ray.set(t,e)}setFromCamera(t,e){e.isPerspectiveCamera?(this.ray.origin.setFromMatrixPosition(e.matrixWorld),this.ray.direction.set(t.x,t.y,.5).unproject(e).sub(this.ray.origin).normalize(),this.camera=e):e.isOrthographicCamera?(this.ray.origin.set(t.x,t.y,(e.near+e.far)/(e.near-e.far)).unproject(e),this.ray.direction.set(0,0,-1).transformDirection(e.matrixWorld),this.camera=e):console.error("THREE.Raycaster: Unsupported camera type: "+e.type)}setFromXRController(t){return wo.identity().extractRotation(t.matrixWorld),this.ray.origin.setFromMatrixPosition(t.matrixWorld),this.ray.direction.set(0,0,-1).applyMatrix4(wo),this}intersectObject(t,e=!0,n=[]){return Qs(t,this,n,e),n.sort(Ro),n}intersectObjects(t,e=!0,n=[]){for(let r=0,s=t.length;r<s;r++)Qs(t[r],this,n,e);return n.sort(Ro),n}}function Ro(i,t){return i.distance-t.distance}function Qs(i,t,e,n){let r=!0;if(i.layers.test(t.layers)&&i.raycast(t,e)===!1&&(r=!1),r===!0&&n===!0){const s=i.children;for(let a=0,o=s.length;a<o;a++)Qs(s[a],t,e,!0)}}class Rp extends Yn{constructor(t,e=null){super(),this.object=t,this.domElement=e,this.enabled=!0,this.state=-1,this.keys={},this.mouseButtons={LEFT:null,MIDDLE:null,RIGHT:null},this.touches={ONE:null,TWO:null}}connect(){}disconnect(){}dispose(){}update(){}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:na}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=na);const li=new qe(0,0,0,"YXZ"),ui=new N,Cp={type:"change"},Pp={type:"lock"},Lp={type:"unlock"},Co=Math.PI/2;class Dp extends Rp{constructor(t,e=null){super(t,e),this.isLocked=!1,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.pointerSpeed=1,this._onMouseMove=Up.bind(this),this._onPointerlockChange=Ip.bind(this),this._onPointerlockError=Np.bind(this),this.domElement!==null&&this.connect()}connect(){this.domElement.ownerDocument.addEventListener("mousemove",this._onMouseMove),this.domElement.ownerDocument.addEventListener("pointerlockchange",this._onPointerlockChange),this.domElement.ownerDocument.addEventListener("pointerlockerror",this._onPointerlockError)}disconnect(){this.domElement.ownerDocument.removeEventListener("mousemove",this._onMouseMove),this.domElement.ownerDocument.removeEventListener("pointerlockchange",this._onPointerlockChange),this.domElement.ownerDocument.removeEventListener("pointerlockerror",this._onPointerlockError)}dispose(){this.disconnect()}getObject(){return console.warn("THREE.PointerLockControls: getObject() has been deprecated. Use controls.object instead."),this.object}getDirection(t){return t.set(0,0,-1).applyQuaternion(this.object.quaternion)}moveForward(t){if(this.enabled===!1)return;const e=this.object;ui.setFromMatrixColumn(e.matrix,0),ui.crossVectors(e.up,ui),e.position.addScaledVector(ui,t)}moveRight(t){if(this.enabled===!1)return;const e=this.object;ui.setFromMatrixColumn(e.matrix,0),e.position.addScaledVector(ui,t)}lock(){this.domElement.requestPointerLock()}unlock(){this.domElement.ownerDocument.exitPointerLock()}}function Up(i){if(this.enabled===!1||this.isLocked===!1)return;const t=i.movementX||i.mozMovementX||i.webkitMovementX||0,e=i.movementY||i.mozMovementY||i.webkitMovementY||0,n=this.object;li.setFromQuaternion(n.quaternion),li.y-=t*.002*this.pointerSpeed,li.x-=e*.002*this.pointerSpeed,li.x=Math.max(Co-this.maxPolarAngle,Math.min(Co-this.minPolarAngle,li.x)),n.quaternion.setFromEuler(li),this.dispatchEvent(Cp)}function Ip(){this.domElement.ownerDocument.pointerLockElement===this.domElement?(this.dispatchEvent(Pp),this.isLocked=!0):(this.dispatchEvent(Lp),this.isLocked=!1)}function Np(){console.error("THREE.PointerLockControls: Unable to use Pointer Lock API")}const Oe=new Ep;Oe.background=new Ft(17);Oe.fog=new ki(17,.008);const jt=new Ae(70,window.innerWidth/window.innerHeight,.1,60);jt.position.set(0,1.6,4);const Qe=new Sp({antialias:!0});Qe.setSize(window.innerWidth,window.innerHeight);Qe.shadowMap.enabled=!0;Qe.shadowMap.type=Io;Qe.toneMapping=Fo;Qe.toneMappingExposure=.7;document.body.appendChild(Qe.domElement);const hi=document.getElementById("hint"),Ut=new Fe;Oe.add(Ut);let fs=null;function Fp(){return fs||(fs=new(window.AudioContext||window.webkitAudioContext)),fs}function un(i,t,e="triangle",n=.04){try{const r=Fp(),s=r.createOscillator(),a=r.createGain();s.type=e,s.frequency.value=i,a.gain.setValueAtTime(n,r.currentTime),a.gain.exponentialRampToValueAtTime(.001,r.currentTime+t),s.connect(a),a.connect(r.destination),s.start(),s.stop(r.currentTime+t)}catch{}}function Op(){un(55+Math.random()*35,.12,"triangle",.025)}function Bp(i,t){const e=document.createElement("canvas");e.width=256,e.height=256;const n=e.getContext("2d");n.fillStyle=t,n.fillRect(0,0,256,256);for(let s=0;s<11;s++){const a=s%2===0?0:32;for(let o=-1;o<9;o++)n.fillStyle=i,n.fillRect(o*66+a+3,s*24+3,60,18)}const r=new dc(e);return r.wrapS=r.wrapT=Ni,r}function zp(){const i=document.createElement("canvas");i.width=256,i.height=256;const t=i.getContext("2d");t.fillStyle="#3a2a1a",t.fillRect(0,0,256,256);for(let n=0;n<20;n++)t.fillStyle=`rgb(${50+Math.random()*20},${35+Math.random()*15},${20+Math.random()*10})`,t.fillRect(Math.random()*256,Math.random()*256,80+Math.random()*60,2);const e=new dc(i);return e.wrapS=e.wrapT=Ni,e}const An=new oe({map:Bp("#4a3a2a","#1a1a0f"),roughness:.85,metalness:.05});An.map.repeat.set(2,6);const pa=new oe({map:zp(),roughness:.9});pa.map.repeat.set(4,4);const mc=new oe({color:2763306,roughness:.9}),Po=new oe({color:2763306,roughness:.5,metalness:.4}),_c=new oe({color:14527044,roughness:.2,metalness:.9}),ye={};document.addEventListener("keydown",i=>{const t=i.key.toLowerCase();"wasde".includes(t)&&(ye[t]=!0,i.preventDefault())});document.addEventListener("keyup",i=>{const t=i.key.toLowerCase();"wasde".includes(t)&&(ye[t]=!1,i.preventDefault())});const Lr=new Dp(jt,Qe.domElement);Qe.domElement.addEventListener("click",()=>{Lr.lock()});Lr.addEventListener("lock",()=>{document.getElementById("info").textContent="WASD 移动 | 鼠标环顾 | E 交互"});Lr.addEventListener("unlock",()=>{document.getElementById("info").textContent="点击画面锁定鼠标"});const Je=new Tp(16772829,20,12,Math.PI/7,.25,.6);Je.castShadow=!0;Je.shadow.mapSize.set(512,512);Je.shadow.camera.near=.1;Je.shadow.camera.far=20;Oe.add(Je);Oe.add(Je.target);let Oi="classroom",Wn=[];const ma=[],Dr=[];let pe,Ke=!0,Er=!1,yr=!1;function Hp(){for(;Ut.children.length>0;)Ut.remove(Ut.children[0]);Wn=[],ma.length=0,Dr.length=0}function Gp(){const n=new oe({color:15261904,roughness:.9}),r=new oe({color:13156528,roughness:.9});Oe.background=new Ft(1118498),Oe.fog=new ki(1118498,.006);const s=new Mt(new fe(7,8),pa);s.rotation.x=-Math.PI/2,s.receiveShadow=!0,Ut.add(s),Ut.add(new Mt(new fe(7,8),mc)).rotation.x=Math.PI/2,Ut.children[Ut.children.length-1].position.set(0,3.5,0);const a=new fe(7,3.5),o=new fe(8,3.5),c=new Mt(a,r);c.position.set(0,3.5/2,-8/2),Ut.add(c);const u=new Mt(a,n);u.position.set(0,3.5/2,8/2),Ut.add(u);const h=new Mt(o,n);h.rotation.y=Math.PI/2,h.position.set(-7/2,3.5/2,0),Ut.add(h);const d=new Mt(o,n);d.rotation.y=-Math.PI/2,d.position.set(7/2,3.5/2,0),Ut.add(d);const f=-8/2,m=new Mt(new le(3,1.2,.05),new oe({color:2245666,roughness:.6}));m.position.set(0,2.2,f+.03),m.receiveShadow=!0,Ut.add(m);const g=new Mt(new fe(2.6,.8),new fn({color:11193514}));g.position.set(0,2.2,f+.06),Ut.add(g);const M=new Mt(new le(1.2,.9,.6),new oe({color:6969914,roughness:.7}));M.position.set(0,.45,f+2.2),M.castShadow=!0,M.receiveShadow=!0,Ut.add(M);for(let V=0;V<2;V++)for(let X=0;X<3;X++){const H=new Fe,et=new Mt(new le(.8,.04,.5),new oe({color:9075290,roughness:.6}));et.position.y=.7,et.castShadow=!0,H.add(et);for(const[ft,It]of[[-.35,-.2],[.35,-.2],[-.35,.2],[.35,.2]]){const Xt=new Mt(new Ne(.03,.03,.7,6),new oe({color:5592405,roughness:.5,metalness:.3}));Xt.position.set(ft,.35,It),H.add(Xt)}H.position.set(-2+X*2,0,.5+V*2.2),Ut.add(H);const rt=new Mt(new le(.35,.04,.35),new oe({color:6710886,roughness:.5,metalness:.2}));rt.position.set(-2+X*2,.45,.85+V*2.2),rt.castShadow=!0,Ut.add(rt)}for(let V=0;V<2;V++){const X=new Fe,H=new Mt(new le(.08,1.5,.08),new oe({color:4473924,roughness:.4,metalness:.3}));H.position.set(0,0,0),X.add(H);const et=new Mt(new le(1.2,.08,.08),H.material);et.position.set(0,.75,0),X.add(et),et.clone().position.set(0,-.75,0),X.add(et);const rt=new Mt(new fe(1.1,1.4),new oe({color:3359846,roughness:.1,metalness:.1,transparent:!0,opacity:.4}));rt.position.set(0,0,-.01),X.add(rt),X.position.set(7/2-.04,2.2,-2+V*4),X.rotation.y=-Math.PI/2,Ut.add(X);const ft=new Sr(3359846,2,6);ft.position.set(7/2-.2,2.2,-2+V*4),Ut.add(ft)}Oe.add(new pc(2236979,.5));const p=new Sr(16777164,5,10);p.position.set(0,3.5-.3,0),Ut.add(p);const l=new Fe,A=new Mt(new le(.25,.02,.35),new oe({color:8939076,roughness:.6}));A.castShadow=!0,l.add(A);const T=new Mt(new fe(.02,.3),new fn({color:16764040}));T.rotation.y=Math.PI/2,T.position.set(.125,.01,0),l.add(T),l.position.set(1.5,.01,-1),l.rotation.z=.15,l.name="diary",Ut.add(l),Wn.push(l);const E=new Sr(16763972,.4,1.5);E.position.copy(l.position),E.position.y+=.1,E.name="diary_glow",Ut.add(E);const I=new Fe,b=new Mt(new Ne(.3,.3,.04,24),new oe({color:15658717,roughness:.4}));b.rotation.x=Math.PI/2,I.add(b);for(let V=1;V<=12;V++){const X=(V-3)*Math.PI/6,H=new Mt(new le(.02,.06,.01),new fn({color:2236962}));H.position.set(Math.cos(X)*.22,.021,Math.sin(X)*.22),H.rotation.z=X,I.add(H)}I.position.set(-7/2+.06,2.2,-1),I.rotation.y=Math.PI/2,I.name="clock",Ut.add(I),Wn.push(I);const w=1.1,C=2.3;pe=new Fe,pe.position.set(-w/2,0,8/2);const S=new le(w-.04,C-.04,.06);S.translate((w-.04)/2,(C-.04)/2,0);const x=new Mt(S,new oe({color:5913114,roughness:.6}));x.castShadow=!0,x.name="door_panel",pe.add(x);const R=_c,G=w-.15,O=C*.45,W=new Mt(new Ne(.03,.04,.02,12),R);W.position.set(G,O,.04),pe.add(W);const q=new Mt(new Ne(.015,.015,.1,12),R);q.rotation.z=Math.PI/2,q.position.set(G+.05,O,.04),pe.add(q),pe.name="door_group",Ut.add(pe),Wn.push(pe);for(let V=0;V<30;V++){const X=new Mt(new _i(.004,3,2),new fn({color:14535850,transparent:!0,opacity:.2+Math.random()*.3}));X.position.set((Math.random()-.5)*7,Math.random()*3.5,(Math.random()-.5)*8),X.userData={baseY:X.position.y,speed:.15+Math.random()*.3,phase:Math.random()*Math.PI*2},Dr.push(X),Ut.add(X)}jt.position.set(0,1.6,3),Je.intensity=5,Ur("探索教室：找到地上的日记本 [E键交互]")}function Vp(){Oe.background=new Ft(328976),Oe.fog=new ki(328976,.012);const n=new Mt(new fe(3,22),pa);n.rotation.x=-Math.PI/2,n.position.set(0,0,-22/2+2),n.receiveShadow=!0,Ut.add(n);const r=new Mt(new fe(3,22),mc);r.rotation.x=Math.PI/2,r.position.set(0,3.5,-22/2+2),Ut.add(r);for(let I=0;I>-20;I-=3){const b=new Mt(new le(3.1,.12,.18),Po);b.position.set(0,3.5-.06,I),b.castShadow=!0,Ut.add(b)}const s=new fe(22,3.5);An.map.repeat.set(2,8);const a=new Mt(s,An);a.rotation.y=Math.PI/2,a.position.set(-3/2,3.5/2,-22/2+2),a.receiveShadow=!0,Ut.add(a);const o=new Mt(s,An);o.rotation.y=-Math.PI/2,o.position.set(3/2,3.5/2,-22/2+2),o.receiveShadow=!0,Ut.add(o);const c=new Mt(new fe(3,3.5),An);c.position.set(0,3.5/2,3),Ut.add(c);const u=-19,h=1.2,d=2.3,f=3.5-d,m=(3-h)/2;Ut.add(new Mt(new fe(h,f),An)).position.set(0,d+f/2,u),Ut.add(new Mt(new fe(m,3.5),An)).position.set(-h/2-m/2,3.5/2,u),Ut.add(new Mt(new fe(m,3.5),An)).position.set(h/2+m/2,3.5/2,u);const g=.08,M=.1;[[-h/2,d/2],[h/2,d/2],[0,d]].forEach(([I,b])=>{const w=b===d,C=new le(w?h+g*2:g,w?g:d,M);Ut.add(new Mt(C,Po)).position.set(I,b,u)}),pe=new Fe,pe.position.set(-h/2,0,u);const p=new le(h-.04,d-.04,.06);p.translate((h-.04)/2,(d-.04)/2,0);const l=new Mt(p,new oe({color:3809296,roughness:.7}));l.castShadow=!0,l.name="door_panel",pe.add(l);const A=h-.15,T=d*.45;[new Ne(.03,.04,.02,12),new Ne(.015,.015,.1,12)].forEach((I,b)=>{const w=new Mt(I,_c);b===1&&(w.rotation.z=Math.PI/2),w.position.set(b===1?A+.05:A,T,.04),pe.add(w)}),pe.name="door_group",Ut.add(pe),Wn.push(pe),Ke=!0;const E=(I,b,w)=>{const C=new Fe,S=new oe({color:2763306,roughness:.4,metalness:.7});C.add(new Mt(new le(.12,.25,.02),S)).position.set(0,0,.01);const x=new Mt(new Ne(.015,.015,.25,8),S);x.rotation.z=Math.PI/2,x.position.set(.12,.08,0),C.add(x),C.add(new Mt(new Ne(.015,.015,.15,8),S)).position.set(.22,.18,0),C.add(new Mt(new Ne(.05,.04,.06,12),S)).position.set(.22,.27,0),C.add(new Mt(new Ne(.025,.028,.08,8),new oe({color:15658717,roughness:.8}))).position.set(.22,.33,0);const R=new _i(.025,8,6);R.scale(.6,1.6,.6);const G=new Mt(R,new fn({color:16746547}));G.position.set(.22,.39,0),C.add(G);const O=new _i(.012,6,4);O.scale(.6,1.5,.6);const W=new Mt(O,new fn({color:16768392}));W.position.set(.22,.383,0),C.add(W);const q=new Sr(16746547,1.8,4,1.5);q.position.set(.22,.39,0),C.add(q),C.userData={flameMesh:G,innerFlame:W,pointLight:q,baseIntensity:1.8};const V=I>0?1:-1;C.position.set(I-V*.06,b,w),C.rotation.y=V>0?-Math.PI/2:Math.PI/2,Ut.add(C),ma.push(C)};E(-3/2,1.8,-3),E(3/2,1.8,-8),E(-3/2,1.8,-14);for(let I=0;I<10;I++){const b=new Mt(new le(.1+Math.random()*.3,.02+Math.random()*.02,.1+Math.random()*.3),new oe({color:3355426,roughness:1}));b.position.set((Math.random()-.5)*2.2,.002,-Math.random()*22+1),b.rotation.y=Math.random()*Math.PI,Ut.add(b)}for(let I=0;I<30;I++){const b=new Mt(new _i(.005,3,2),new fn({color:13421738,transparent:!0,opacity:.2+Math.random()*.3}));b.position.set((Math.random()-.5)*2.5,Math.random()*3.5,-Math.random()*22+1),b.userData={baseY:b.position.y,speed:.2+Math.random()*.3,phase:Math.random()*Math.PI*2},Dr.push(b),Ut.add(b)}Oe.add(new pc(1118498,.3)),Je.intensity=25,jt.position.set(0,1.6,1.5),Ur("探索黑贝街12号走廊...")}function Ur(i){const t=document.getElementById("objective");t&&(t.textContent=i)}function kp(){Hp(),Oi="hallway",Vp()}function Lo(){if(!pe)return;const i=Ke?-Math.PI/2:0,t=Ke?0:-Math.PI/2;let e=0;const n=performance.now();Ke=!Ke;function r(s){e=Math.min((s-n)/800,1),pe.rotation.y=t+(i-t)*(1-Math.pow(1-e,3)),e<1?requestAnimationFrame(r):Oi==="classroom"&&!Ke&&setTimeout(()=>kp(),400)}requestAnimationFrame(r),un(Ke?80:100,.4,"sawtooth")}const ta=new wp;ta.far=2.8;function Wp(){ta.set(jt.position,jt.getWorldDirection(new N));const i=ta.intersectObjects(Wn,!0);if(hi.textContent="",i.length===0)return;let e=i[0].object;for(;e&&!Wn.includes(e);)e=e.parent;e&&(Oi==="classroom"?e.name==="diary"&&!Er?(hi.textContent="按 E 捡起日记",ye.e&&(ye.e=!1,Xp())):e.name==="clock"&&!yr?(hi.textContent="按 E 查看挂钟",ye.e&&(ye.e=!1,qp())):e.name==="door_group"&&Er&&yr?(hi.textContent="按 E 打开门",ye.e&&(ye.e=!1,Lo())):e.name==="door_group"&&(!Er||!yr)&&(hi.textContent="门锁着...需要先解开教室里的谜题"):Oi==="hallway"&&e.name==="door_group"&&(hi.textContent=Ke?"按 E 打开门":"门已打开",ye.e&&Ke&&(ye.e=!1,Lo())))}function Xp(){Er=!0;const i=Ut.children.find(t=>t.name==="diary_glow");i&&(i.intensity=0),un(440,.1,"sine",.06),setTimeout(()=>un(660,.08,"sine",.04),100),Tr(`日记上刻着四个字母：R H B Z
旁边有数字 1-10
